...
We keep this rewriter intentionally conservative: it only touches string
literals in common import-like constructs, and currently only applies the
``specs -> specs/v1`` mapping.
"""
