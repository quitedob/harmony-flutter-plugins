...
| permissions | Array<string> | 是 | 否 | 被其他应用Ability调用时需要申请的权限集合。  通过调用[bundle.getAbilityInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-bundle#bundlegetabilityinfodeprecated)接口时，传入GET\_ABILITY\_INFO\_WITH\_PERMISSION获取。 |
...
| applicationInfo | [ApplicationInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-bundle-applicationinfo) | 是 | 否 | 应用程序的配置信息。  通过调用[bundle.getAbilityInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-bundle#bundlegetabilityinfodeprecated)接口时，传入GET\_ABILITY\_INFO\_WITH\_APPLICATION获取。 |
...
| metaData8+ | Array<[CustomizeData](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-bundle-customizedata)> | 是 | 否 | Ability的元信息。  通过调用[bundle.getAbilityInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-bundle#bundlegetabilityinfodeprecated)接口时，传入GET\_ABILITY\_INFO\_WITH\_METADATA获取。 |
