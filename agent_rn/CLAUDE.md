...
| HarmonyOS 开发指南 / 权限 / Kit 教程 | `sub-doc-search` → `harmonyos-docs-search` Skill | 搜索官方文档 |
...
- 通过 `sub-doc-search` 搜索开发文档（路由至 `harmonyos-docs-search`）
...
| testing | `04-testing.json` | `04-testing-report.md` |
