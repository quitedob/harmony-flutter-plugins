...
- **测试用例 JSON**：`.rn-ohos-adaptation/04-test-cases.json`
- **测试点汇总**：`.rn-ohos-adaptation/01-test-points.json`
- **测试分析报告**：`.rn-ohos-adaptation/01-test-analysis-report.md`

---

## 输出

- **用例评审报告**：`.rn-ohos-adaptation/03-case-review-report.md`
...
> **校验脚本**：`python .claude/skills/03-case-review/scripts/verify_test_cases.py .rn-ohos-adaptation`（不要用内联命令）
