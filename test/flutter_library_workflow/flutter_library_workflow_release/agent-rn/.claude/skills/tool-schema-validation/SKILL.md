...
| testing（example生成） | `.claude/skills/tool-schema-validation/json-schema/04-testing.schema.json` | `.claude/skills/tool-schema-validation/docs/04-testing.md` |
| device-verify（测试验证） | `.claude/skills/tool-schema-validation/json-schema/04-device-verify.schema.json` | — |
