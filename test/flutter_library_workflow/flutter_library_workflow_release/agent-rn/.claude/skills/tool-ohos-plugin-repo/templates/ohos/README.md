...
```json
"dependencies": {
  "@oh-rn/xxx": "file:../../node_modules/@oh-rn/xxx/harmony/xxx.har"
}
```
...
add_subdirectory("${OH_MODULES}/@oh-rn/xxx/src/main/cpp" ./xxx)
...
```typescript
import { XxxPackage } from '@oh-rn/xxx/ts';
