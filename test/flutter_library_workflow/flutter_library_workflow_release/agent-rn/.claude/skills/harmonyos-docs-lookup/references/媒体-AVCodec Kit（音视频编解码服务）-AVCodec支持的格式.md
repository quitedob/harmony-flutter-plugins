...
| MJPEG 22+ | [OH\_AVCODEC\_MIMETYPE\_VIDEO\_MJPEG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-avcodec-base-h#变量) |
...
| 音视频 | avi | 视频轨：H.263、AVC(H.264)、MPEG2、MPEG4、MJPEG22+、MSVIDEO122+  音频轨：AAC、MPEG(MP2、MP3)、PCM、GSM\_MS22+、ADPCM\_YAMAHA22+、ADPCM\_G72222+ |
...
| 音频 | ogg | 音频轨：Vorbis |
| 音频 | flac | 音频轨：Flac |
| 音频 | wav | 音频轨：PCM、G711mu、G711a、GSM\_MS22+、ADPCM\_YAMAHA22+、ADPCM\_G72222+、ADPCM\_G72622+ |
| 音频 | amr | 音频轨：AMR(amrnb、amrwb) |
| 音频 | ape | 音频轨：APE |
| 音频 | wma22+ | 音频轨：AC3、WMAV1、WMAV2、Vorbis、Flac、AMR(amrnb、amrwb)、AAC、MPEG(MP2、MP3)、GSM\_MS、G711mu、G711a、PCM、ADPCM\_G722、ADPCM\_G726、ADPCM\_IMA\_WAV、ADPCM\_MS、ADPCM\_YAMAHA |
| 外挂字幕 | srt | 字幕轨：SRT |
