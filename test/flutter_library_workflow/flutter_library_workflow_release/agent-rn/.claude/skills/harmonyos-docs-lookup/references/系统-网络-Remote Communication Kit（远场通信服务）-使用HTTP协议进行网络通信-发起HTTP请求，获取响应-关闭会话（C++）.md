...
| 接口名 | 描述 |
| --- | --- |
| uint32\_t HMS\_Rcp\_CloseSession([Rcp\_Session](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/remote-communication-overview#ga4f3a7d39c18fe6fdf01c52759213ddcd) \*\*session); | 关闭会话。 |
