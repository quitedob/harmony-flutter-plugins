...
用于设置组件是否应用窗口定义的效果模板。与[useEffect14+](/consumer/cn/doc/harmonyos-references/ts-universal-attributes-use-effect#useeffect14)相比，useEffect参数新增了对undefined类型的支持。
