...
declare namespace systemShare {
    ...
    interface ShareControllerOptions {
        ...
        /**
         * Indicates configuration the trustlist of target applications for system sharing.
         *
         * @permission ohos.permission.SET_SYSTEMSHARE_APPLAUNCHTRUSTLIST
         * @type { ?Array<string> }
         * @syscap SystemCapability.Collaboration.SystemShare
         * @stagemodelonly
         * @since 6.0.1(21)
         */
        appLaunchTrustInfo?: Array<string>;
    }
    /**
     *  Indicates abilityName defined by SystemShare.
     *
     * @enum { string }
     * @syscap SystemCapability.Collaboration.SystemShare
     * @stagemodelonly
    ...
    enum ShareAbilityName {
         ...
         * @since 5.1.0(18)
         */
        COPY_TO_PASTEBOARD = 'SystemShare_CopyToPasteboard',
        /**
         * Indicates the Ability of save files as media assets.
         *
         * @syscap SystemCapability.Collaboration.SystemShare
         ...
         * @since 5.1.0(18)
         */
        SAVE_TO_MEDIA_ASSET = 'SystemShare_SaveToMediaAsset',
        /**
         * Indicates the Ability of save files as normal files.
         *
         * @syscap SystemCapability.Collaboration.SystemShare
         ...
         * @since 5.1.0(18)
         */
        SAVE_AS_FILE = 'SystemShare_SaveAsFile',
        /**
         * Indicates the Ability of Print.
         *
         * @syscap SystemCapability.Collaboration.SystemShare
         ...
         * @since 5.1.0(18)
         */
        SAVE_TO_SUPERHUB = 'SystemShare_Superhub',
        /**
         * Indicates the Ability of Collection.
         *
         * @syscap SystemCapability.Collaboration.SystemShare
         * @stagemodelonly
         * @since 5.1.0(18)
         */
        COLLECTION = 'SystemShare_Collection',
        /**
         * Indicates the Ability of HarmonyShare.
         *
         * @syscap SystemCapability.Collaboration.SystemShare
         * @stagemodelonly
         * @since 5.1.0(18)
         */
        HARMONYSHARE = 'SystemShare_HarmonyShare',
        /**
         * Indicates the Ability of Encrypt.
         *
         * @syscap SystemCapability.Collaboration.SystemShare
         * @stagemodelonly
         * @since 5.1.0(18)
         */
        ENCRYPT = 'SystemShare_Encrypt'
    }
    /**
     * Indicates the abilityInfo of Share operation
     * @typedef ShareAbilityInfo
     * @syscap SystemCapability.Collaboration.SystemShare
     * @stagemodelonly
     * @since 5.1.0(18)
     */
    interface ShareAbilityInfo {
        /**
         * Indicates the name of share ability.
         *
         * @type { string }
         * @syscap SystemCapability.Collaboration.SystemShare
         * @stagemodelonly
    ...
    /**
     * Indicates result of Share operation
     * @typedef ShareOperationResult
     * @syscap SystemCapability.Collaboration.SystemShare
     * @stagemodelonly
     * @since 5.1.0(18)
     */
    interface ShareOperationResult {
        /**
         * Indicates share target ability Information
         *
         * @type { ShareAbilityInfo }
         * @readonly
         * @syscap SystemCapability.Collaboration.SystemShare
         * @stagemodelonly
         * @since 5.1.0(18)
         */
        targetAbilityInfo: ShareAbilityInfo;
    }
    /**
    ...
    class ShareController {
        ...
        /**
         * Register Share Operation Completed Result callback.
         *
         * @param { 'shareCompleted' } type - share operation completed type.
         * @param { Callback<ShareOperationResult> } callback - Called when share operation completed.
         * @throws { BusinessError } 401 - Parameter error.
         * @syscap SystemCapability.Collaboration.SystemShare
         * @stagemodelonly
         * @since 5.1.0(18)
         ...
         *
         * @param { 'shareCompleted' } type - canceled type.
         * @param { Callback<ShareOperationResult> } [callback] - Called when share operation completed.
         * @throws { BusinessError } 401 - Parameter error.
         * @syscap SystemCapability.Collaboration.SystemShare
         * @stagemodelonly
