...
declare namespace weatherService {
    ...
    /**
     * Returns the weather forecast for the requested location based on the given context.
     *
     ...
     * @since 5.0.2(14)
     */
    function getWeatherWithContext(context: common.Context, request: WeatherRequest): Promise<Weather>;
    /**
