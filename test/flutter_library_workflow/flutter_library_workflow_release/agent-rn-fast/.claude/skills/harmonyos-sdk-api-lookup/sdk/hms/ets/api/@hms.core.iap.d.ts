...
declare namespace iap {
    ...
    interface PurchaseParameter {
        ...
        /**
         * The number of products to be purchased.
         *
         * @type { ?number }
         * @syscap SystemCapability.Payment.IAP
         * @stagemodelonly
    ...
    interface Product {
         ...
         * @since 4.0.0(10)
         * @deprecated since 4.1.0(11)
         * @useinstead iap.Product#localPrice
         */
        price: string;
        /**
         * Displayed price of a product, including the currency symbol and actual price of the product.
     ...
     *
     * @param { common.UIAbilityContext } context - The context of an ability.
     * @param { string[] } productIds - ID list of products to be queried.
     * @returns { Promise<Array<Product>> } Returns an array of products.
     * @throws { BusinessError } 1001860001 - System internal error.
     * @throws { BusinessError } 1001860002 - The application is not authorized.
     * @throws { BusinessError } 1001860003 - Invalid product information.
     ...
     * @since 6.0.0(20)
     */
    function queryProducts(context: common.UIAbilityContext, productIds: string[]): Promise<Array<Product>>;
    /**
    ...
    /**
     * Create refund request and present refund page.
     *
     * @param { common.Context } context - The context of an ability.
     * @param { string } purchaseOrderId - Purchase order ID returned in the purchase order payload.
     * @returns { Promise<void> } return void
     ...
     * @throws { BusinessError } 1001860005 - Network connection error.
     * @throws { BusinessError } 1001860054 - The country or region of the signed-in HUAWEI ID does not support IAP.
     * @throws { BusinessError } 1001860061 - The purchase has been refunded or in refund.
     * @throws { BusinessError } 1001860062 - Refund is not allowed.
     * @syscap SystemCapability.Payment.IAP
     * @stagemodelonly
     * @atomicservice
     * @since 5.0.3(15)
     */
    function createRefundRequest(context: common.Context, purchaseOrderId: string): Promise<void>;
    /**
    ...
    enum ProductType {
        ...
        AUTORENEWABLE = 2,
        /**
         * Non-renewable subscription product
         *
         * @syscap SystemCapability.Payment.IAP
         * @stagemodelonly
         * @atomicservice
    ...
    enum PurchaseQueryType {
        ...
        UNFINISHED = 1,
        /**
         * The latest purchase for each product that customer has an entitlement to.
         *
         * @syscap SystemCapability.Payment.IAP
         * @stagemodelonly
         * @since 4.1.0(11)
    ...
    enum IAPErrorCode {
         ...
         * @since 5.0.3(15)
         */
        PURCHASE_ALREADY_REFUNDED = 1001860061,
        /**
