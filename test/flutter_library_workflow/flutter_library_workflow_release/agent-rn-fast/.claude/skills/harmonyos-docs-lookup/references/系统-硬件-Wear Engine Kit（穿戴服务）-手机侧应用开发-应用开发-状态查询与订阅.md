...
* 查询和订阅佩戴状态、心率告警时，需要申请穿戴用户状态[USER\_STATUS](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/wearengine_api#section09971113566)权限。
...
4. 调用[queryStatus](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/wearengine_api#section3383841153218)方法，查询指定指标状态。
   ...
   * 通过[MonitorData](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/wearengine_api#section12024822410)对象，返回指定指标状态的查询结果。
...
6. 调用[unsubscribeEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/wearengine_api#section182736075018)方法，解除穿戴设备状态变化的订阅。（需要传入订阅时使用的回调函数对象）
