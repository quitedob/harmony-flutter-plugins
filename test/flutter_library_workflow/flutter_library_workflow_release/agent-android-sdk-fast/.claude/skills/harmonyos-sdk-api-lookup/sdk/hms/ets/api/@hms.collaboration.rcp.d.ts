...
declare namespace rcp {
    ...
    export interface InfoToCollect {
        ...
        /**
         * Indicates whether to collect local address information events. By default, such events are not collected.
         * @type { ?boolean }
         * @default false
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
        ...
        srcAddr?: boolean;
        /**
         * Indicates whether to collect peer address information events. By default, such events are not collected.
         * @type { ?boolean }
         * @default false
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
    ...
    export interface TcpConfiguration {
        /**
         * Time (in seconds) during which the connection needs to remain idle before TCP starts sending keepalive probes.
         * @type {?number}
         * @default 7200
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
        ...
        keepIdleSec?: number;
        /**
         * When the value is greater than 0, it specifies the maximum amount of time in milliseconds that transmitted
         * data may remain unacknowledged, or buffered data may remain untransmitted (due to zero window size) before
        ...
        /**
         * Maximum number of keepalive probes that TCP needs to send before dropping the connection.
         * @type {?number}
         * @default 9
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
        ...
        keepCnt?: number;
        /**
         * Interval between individual keepalive probes (in seconds).
         * @type {?number}
         * @default 75
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
    ...
    export interface DnsConfiguration {
        ...
        /**
         * Enable happy eyeball when dns rule is set.
         *
         * Since specific addresses or address families (IPv4 or IPv6) may be blocked, broken, or sub-optimal on a network,
         * this flag can attempt multiple connections in parallel and have a chance of establishing a connection
         * more quickly.
         * @type {?boolean}
         * @default false
         * @syscap SystemCapability.Collaboration.RemoteCommunication
    ...
    export interface SecurityConfiguration {
        ...
        /**
         * If both tlsRange and tlsOptions {@link tlsOptions} are set, only tlsRange will take effect.
         * @type { ?TlsVersionRangeOptions }
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
         */
        tlsRange?: TlsVersionRangeOptions;
    }
    /**
     ...
     * @typedef {function}
     * @param { ArrayBuffer } incomingData - Received HTTP data.
     * @param { Request } [request] - Indicates this callback happens on which request.
     * @returns { number | void | Promise<void> } Return data of type number | void | Promise<void>.
     * @syscap SystemCapability.Collaboration.RemoteCommunication
     * @since 6.0.0(20)
     */
    ...
    /**
     * Returns the time consumed in each phrase in the HTTP access process upon the access success or failure.
     * @typedef OnTimeInfo
     * @param { TimeInfo } timeInfo Time consumed in each phrase in the HTTP access process.
     * @syscap SystemCapability.Collaboration.RemoteCommunication
     * @since 5.0.3(15)
     */
    /**
    ...
    /**
     * Callback function triggered when the HTTP response status code is received.
     * @typedef {function}
     * @param { number } statusCode - Received status code.
     * @param { Request } [request] - Indicates this callback happens on which request.
     * @returns { void } Return the void type.
     * @syscap SystemCapability.Collaboration.RemoteCommunication
     * @since 6.0.0(20)
     */
    ...
    export interface HttpEventsHandler {
        ...
        /**
         * Callback function triggered when the response status code is received.
         * @type { ?OnStatusCodeReceive }
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
         */
        onStatusCodeReceive?: OnStatusCodeReceive;
    }
    /**
     * Certificate authority(CA) which is used to verify the remote server's identification.
    ...
    export class Request {
        ...
        /**
         * If set overrides cache control settings set for the session.
         * @type {?CacheControl}
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
         */
    ...
    export class Form {
        ...
        fields: FormFields;
        /**
         * Defines keys order in the HTTP form.
         * @type { ?string[] }
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.1(21)
         */
    ...
    export class MultipartForm {
         ...
         * Constructor of {@link MultipartForm}. {@link fields} is needed.
         * @param { MultipartFormFields } fields - Representing multi-part form data.
         * @param { string } boundary - Representing boundary for multi-part form data.
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 5.1.0(18)
         */
        constructor(fields: MultipartFormFields, boundary: string);
        /**
         * Defines data boundaries in the HTTP multi-part form.
         * @type { ?string }
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 5.1.0(18)
         */
        boundary?: string;
        /**
         * Defines keys order in the HTTP multi-part form.
         * @type { ?string[] }
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.1(21)
         */
    ...
    export interface Response {
        ...
        /**
         * Response age and other cache-related information. Set this field if the response is obtained from the
         * cache.
         * @type { ?CacheInfo }
         * @readonly
         * @syscap SystemCapability.Collaboration.RemoteCommunication
    ...
    /**
     * HTTP responses support Sendable.
     * @interface ResponseSendable
     * @syscap SystemCapability.Collaboration.RemoteCommunication
     * @since 6.0.0(20)
     */
    export interface ResponseSendable {
        /**
         * Unique ID of a single request, which is generated by the system.
         * @type { string }
         * @readonly
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
        ...
        readonly body?: ArrayBuffer;
        /**
         * Target path for downloading content.
         * @type { ?DownloadedTo }
         * @readonly
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
        ...
        readonly reasonPhrase?: string;
        /**
         * Response age and other cache-related information. This field needs to be set if the response is obtained
         * from the cache.
         * @type { ?CacheInfo }
         * @readonly
         * @syscap SystemCapability.Collaboration.RemoteCommunication
    ...
    /**
     * HTTP response debugging event type.
     *
     * @syscap SystemCapability.Collaboration.RemoteCommunication
     * @since 4.1.0(11)
     */
     ...
     * HTTP response debugging event type.
     *
     * @typedef {'text' | 'headerIn' | 'headerOut' | 'dataIn' | 'dataOut' | 'sslDataIn' | 'sslDataOut' |
     * 'srcAddr' | 'dstAddr'}
     * @syscap SystemCapability.Collaboration.RemoteCommunication
     * @since 6.0.0(20)
     */
    export type DebugEvent = 'text' | 'headerIn' | 'headerOut' | 'dataIn' | 'dataOut' | 'sslDataIn' | 'sslDataOut' | 'srcAddr' | 'dstAddr';
    /**
    ...
    export interface Session {
         ...
         * @throws { BusinessError } 1007900002 - Initialization failed.
         ...
         * @throws { BusinessError } 1007900023 - Error occurred when writing data to the local file system.
         ...
         * @throws { BusinessError } 1007900035 - Error occurred during SSL connection.
         * @throws { BusinessError } 1007900037 - Couldn't read a file:// file.
         * @throws { BusinessError } 1007900042 - Callback function termination.
         * @throws { BusinessError } 1007900045 - Failed binding local connection end.
         * @throws { BusinessError } 1007900047 - Number of redirects hit maximum amount.
         * @throws { BusinessError } 1007900049 - The option format is incorrect.
         ...
         * @throws { BusinessError } 1007900065 - Send failed since rewinding of the data stream failed.
         ...
         * @throws { BusinessError } 1007900089 - No connections available, sessions will be processed in order.
         * @throws { BusinessError } 1007900090 - The specified fixed public key fails to be matched.
         * @throws { BusinessError } 1007900092 - Error occurred in the stream in the HTTP2 frame layer.
         * @throws { BusinessError } 1007900094 - An authentication function returned an error.
         * @throws { BusinessError } 1007900095 - The HTTP3 stream status is abnormal. HTTP3 stream may have been closed.
         * @throws { BusinessError } 1007900097 - Proxy handshake error.
         * @throws { BusinessError } 1007900100 - A value or data field grew larger than allowed.
         ...
         * @throws { BusinessError } 1007900993 - Session is closed.
         * @throws { BusinessError } 1007900992 - Request is canceled.
         * @throws { BusinessError } 1007900991 - The response is invalid.
         * @throws { BusinessError } 1007900988 - Error occurred when opening the file.
         * @throws { BusinessError } 1007900987 - Error occurred when creating the directory.
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 5.0.0(12)
         */
        /**
         ...
         * @throws { BusinessError } 1007900988 - Error occurred when opening the file.
         * @throws { BusinessError } 1007900987 - Error occurred when creating the directory.
         * @throws { BusinessError } 1007900986 - Unable to establish cellular data link.
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 5.1.0(18)
         */
        fetch(request: Request): Promise<Response>;
        /**
         * Send an HTTP request and obtain an HTTP response that supports Sendable.
         * Need ohos.permission.GET_NETWORK_INFO If you want to use 'cellular' of {@link PathPreference}.
         * @permission ohos.permission.INTERNET
         * @param { Request } request - An {@link Request} object.
         * @returns { Promise<ResponseSendable> } The promise returned by the function.
    ...
    /**
     * The cache mechanism can be implemented by specifying cache control instructions in HTTP requests.
    ...
    export interface CacheControl {
        /**
         * Expiration policy of cache records created for requests. Settings this parameter will overwrite the
         * existing expiration policy.
         *
         * @type { ?TimeLimitedExpirationPolicy }
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
         */
        expirationPolicy?: TimeLimitedExpirationPolicy;
        /**
         * When this parameter is true, for requests using the unsafe HTTP method (in accordance with RFC 9110),
         * the cache entry will not be invalidated.
         * @type { ?boolean }
         * @default false
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
        ...
        keepCache?: boolean;
        /**
         * If the parameter is set to no-cache, the no-cache instruction is added to the cache-control header in
         * the request.
         * @type { ?boolean }
         * @default false
         * @syscap SystemCapability.Collaboration.RemoteCommunication
        ...
        noCache?: boolean;
        /**
         * If the parameter is set to no-store, the no-store instruction is added to the cache-control header in
         * the request.
         * @type { ?boolean }
         * @default false
         * @syscap SystemCapability.Collaboration.RemoteCommunication
        ...
        noStore?: boolean;
        /**
         * If the max-age instruction is used, the value max-age is added to the cache-control header in the
         * request.
         *
         * @type { ?TimeInterval }
         * @syscap SystemCapability.Collaboration.RemoteCommunication
        ...
        maxAge?: TimeInterval;
        /**
         * If the max-stale instruction is used, the value max-stale is added to the cache-control header in the
         * request.
         *
         * @type { ?TimeInterval }
         * @syscap SystemCapability.Collaboration.RemoteCommunication
        ...
        /**
         * If the min-fresh instruction is used and a corresponding value is defined, the value is added to the
         ...
         * @since 6.0.0(20)
         */
        minFresh?: TimeInterval;
        /**
         * If the parameter is set to no-transform, the no-transform instruction is added to the cache-control
        ...
        noTransform?: boolean;
        /**
         * If the only-if-cached instruction is used, it is added to the cache-control header in the request.
         * @type { ?boolean }
         * @default false
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
    ...
    export interface CacheInfo {
        /**
         * Specifies the request identifier based on which a request is created.
         * @type { string }
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
         */
    ...
    /**
     * Limited in time expiration policy.
     * @typedef {AbsoluteTimeExpirationPolicy | RelativeTimeExpirationPolicy | SlidingTimeExpirationPolicy}
     * @syscap SystemCapability.Collaboration.RemoteCommunication
     * @since 6.0.0(20)
     */
    export type TimeLimitedExpirationPolicy = AbsoluteTimeExpirationPolicy | RelativeTimeExpirationPolicy | SlidingTimeExpirationPolicy;
    /**
     * Cache record expiration policy.
     * @typedef {NeverExpirationPolicy | TimeLimitedExpirationPolicy}
     * @syscap SystemCapability.Collaboration.RemoteCommunication
     * @since 6.0.0(20)
     */
    export type ExpirationPolicy = NeverExpirationPolicy | TimeLimitedExpirationPolicy;
    /**
     * Expiration policy treating the cache record as never expiring.
     * The cache record stays in the cache until the cache size limit is exceeded.
     * @interface NeverExpirationPolicy
     * @syscap SystemCapability.Collaboration.RemoteCommunication
     * @since 6.0.0(20)
     */
    export interface NeverExpirationPolicy {
        /**
    ...
    /**
     * Expiration policy based on absolute time.
     * @interface AbsoluteTimeExpirationPolicy
     * @syscap SystemCapability.Collaboration.RemoteCommunication
     * @since 6.0.0(20)
     */
    export interface AbsoluteTimeExpirationPolicy {
        /**
         * The discriminator field.
         * @type { 'absolute' }
         * @syscap SystemCapability.Collaboration.RemoteCommunication
        ...
        kind: 'absolute';
        /**
         * Specifies the time when the record expires. It will be removed from the cache.
         * @type { Date }
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
         */
    ...
    /**
     * Expiration policy based on time interval.
     * The record expires once the specified time interval has elapsed.
     * @interface RelativeTimeExpirationPolicy
     * @syscap SystemCapability.Collaboration.RemoteCommunication
     * @since 6.0.0(20)
     */
    export interface RelativeTimeExpirationPolicy {
        /**
         * The discriminator field.
         * @type { 'relative' }
         * @syscap SystemCapability.Collaboration.RemoteCommunication
        ...
        kind: 'relative';
        /**
         * Specifies the time interval after which the record expires.
         * @type { TimeInterval }
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
         */
    ...
    /**
     * Expiration policy based on time interval.
     * The time interval within which the cache record should be accessed, otherwise the cache record expires.
     * Accessing refers to calling 'get' or 'has' cache method with the cache record's key.
     * @interface SlidingTimeExpirationPolicy
     * @syscap SystemCapability.Collaboration.RemoteCommunication
     * @since 6.0.0(20)
     */
    export interface SlidingTimeExpirationPolicy {
        /**
         * The discriminator field.
         * @type { 'sliding' }
         * @syscap SystemCapability.Collaboration.RemoteCommunication
        ...
        kind: 'sliding';
        /**
         * Specifies the time interval after which the cache record expires if not accessed.
         * @type { TimeInterval }
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
         */
    ...
    export interface TimeInterval {
        /**
         * Specifies units used to express the time interval length.
         * @type { TimeIntervalUnits }
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
         */
        units: TimeIntervalUnits;
        /**
         * Specifies the length of the time interval in the selected units.
         * @type { number }
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
         */
    ...
    /**
     * Time interval units.
     * @typedef {'seconds' | 'minutes' | 'hours' | 'days'}
     * @syscap SystemCapability.Collaboration.RemoteCommunication
     * @since 6.0.0(20)
     */
    export type TimeIntervalUnits = 'seconds' | 'minutes' | 'hours' | 'days';
    /**
     * Response data stored in the cache.
    ...
    export interface CachedResponse {
        /**
         * Specifies when the response was obtained from the network.
         * @type { Date }
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
         */
        timeStamp: Date;
        /**
         * Specifies the initial request identifier which caused the response creation.
         * @type { string }
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
         */
        ...
        body?: ArrayBuffer;
        /**
         * See {@link Response.effectiveUrl}.
         * @type { ?string }
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
         */
         ...
         * @type { ?rcp.HttpVersion }
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
         */
        httpVersion?: rcp.HttpVersion;
        /**
         * See {@link Response.reasonPhrase}.
         * @type { ?string }
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
         */
    ...
    export interface ResponseCacheKey {
        /**
         * URL associated with the response. Usually request URL.
         * @type { URLOrString }
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
         */
        ...
        method: HttpMethod;
        /**
         * Used in case multiple responses need to be stored for the same URL and method.
         * @type { ?string }
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
         */
    ...
    /**
     * Response cache record.
     * @typedef ResponseCacheRecord
     * @syscap SystemCapability.Collaboration.RemoteCommunication
     * @since 6.0.0(20)
     */
    export interface ResponseCacheRecord {
        /**
         * Expiration policy set for the record.
        ...
        /**
         * The response stored in the record.
         * @type { CachedResponse }
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
         */
        ...
        /**
         * The response record key.
         * @type { ResponseCacheKey }
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
         */
    ...
    export interface CacheConfiguration {
        /**
         * Specifies the persistent storage settings.
         * @type { PersistentStorageConfiguration }
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
         */
        persistent: PersistentStorageConfiguration;
        /**
         * Specifies the internal memory cache settings {@link InMemoryCacheConfiguration}.
         * @type { ?InMemoryCacheConfiguration }
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
         */
        inMemory?: InMemoryCacheConfiguration;
        /**
         * Specifies the maximum number of responses in the cache. If set, new responses evict older responses
         * when value is exceeded. The oldest responses are evicted first, starting with those that expire earlier.
         * @type { ?number }
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
         */
        maxItems?: number;
        /**
         * Specifies the maximum sum of responses size in the cache. New responses evict older responses
         * when the value is exceeded. The oldest responses are evicted first, starting with those that expire earlier.
         * 50 MBytes by default.
         * @type { ?number }
         * @default 50
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
        ...
        maxSize?: number;
        /**
         * Specifies the default cache records expiration policy. See {@link CacheExpirationPolicy}.
         * If set, it is applied to each added response record unless the record has its own expiration policy.
         * If not set, the {@link SlidingTimeExpirationPolicy} with expiration set to 1 Hour will be applied implicitly.
         * @type { ?TimeLimitedExpirationPolicy }
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
         */
        defaultExpirationPolicy?: TimeLimitedExpirationPolicy;
    }
    /**
     * The type describes the configuration of the persistent cache storage.
     * @typedef {FileSystemStorageConfiguration}
     * @syscap SystemCapability.Collaboration.RemoteCommunication
     * @since 6.0.0(20)
     */
    export type PersistentStorageConfiguration = FileSystemStorageConfiguration;
    /**
     * The type describes the configuration of file-system-based persistent cache storage.
     * @interface FileSystemStorageConfiguration
     * @syscap SystemCapability.Collaboration.RemoteCommunication
     * @since 6.0.0(20)
     */
    export interface FileSystemStorageConfiguration {
        /**
         * The discriminator field.
         * @type { 'file-system' }
         * @syscap SystemCapability.Collaboration.RemoteCommunication
        ...
        kind: 'file-system';
        /**
         * Specifies the path to the folder that will store the cache data.
         * @type { string }
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
         */
    ...
    /**
     * Specifies the internal memory cache settings.
     * @interface InMemoryCacheConfiguration
     * @syscap SystemCapability.Collaboration.RemoteCommunication
     * @since 6.0.0(20)
     */
    export interface InMemoryCacheConfiguration {
        /**
         * Specifies the maximum number of records in the internal memory cache.
         * @type { ?number }
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
         */
        maxItems?: number;
        /**
         * Specifies the maximum sum of records size in the internal memory cache.
         * 10 MBytes by default.
         * @type { ?number }
         * @default 10
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
    ...
    export interface CacheState {
        /**
         * Sum of the response sizes stored in the cache.
         * @type { number }
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
         */
        size: number;
        /**
         * Number of the response stored in the cache.
         * @type { number }
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
         */
        count: number;
        /**
         * Counter of the successful access to the cache.
         * Each call to the {@link ResponseCache.get} method returned a response increements this field.
         * @type { number }
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
         */
    ...
    export class ResponseCache {
         ...
         * @param { CacheConfiguration } configuration - Cache configuration. See {@link CacheConfiguration}.
         * @throws { BusinessError } 1007900401 - Parameter error. Possible causes:
         * 1. Empty path to the data folder has been specified.
         * 2. Negative limits, such as max size, max count, have been specified.
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
         */
        constructor(configuration: CacheConfiguration);
        /**
         * Finalizes all pending cache operations and clears references to internal cache objects.
         * @returns { Promise<void> } Return Promise<void>.
         * and clearing references to internal cache objects.
         * @throws { BusinessError } 1007900985 - File system IO error.
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
         */
        close(): Promise<void>;
        /**
         * Adds or replaces the specified response in the cache.
         * @param { ResponseCacheKey } key - Key of the response.
         * @param { CachedResponse } response - Response to be added or replaced in the cache.
         * @param { ExpirationPolicy } [expirationPolicy] - Expiration policy for the cache record.
         * It takes precedence over the default expiration policy.
         * @returns { Promise<void> } Return Promise<void>.
         * @throws { BusinessError } 1007900401 - Parameter error. Reported in case parameter verification failed.
         * @throws { BusinessError } 1007900985 - File system IO error.
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
         */
        ...
        /**
         * Retrieves the response with the associated data.
         * @param { ResponseCacheKey } key - Key of the response.
         * @returns { Promise<ResponseCacheRecord> } Retrieved response record, or `undefined` if the key is not found
         * in the cache.
         * @throws { BusinessError } 1007900401 - Parameter error. Reported in case parameter verification failed.
         * @throws { BusinessError } 1007900985 - File system IO error.
         * @syscap SystemCapability.Collaboration.RemoteCommunication
        ...
        clear(): Promise<void>;
        /**
         * Obtains the current cache status.
         * @returns { Promise<CacheState> } Returns the cache state data. See {@link CacheState}.
         * @throws { BusinessError } 1007900985 - File system IO error.
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
         */
        ...
        /**
         * Removes record with the specified key from the cache.
         * @param { ResponseCacheKey } key - Keys of the record to remove.
         * @returns { Promise<boolean> } `true` if a record was removed from the cache; otherwise: `false`.
         * @throws { BusinessError } 1007900401 - Parameter error. Reported in case parameter verification failed.
         * @throws { BusinessError } 1007900985 - File system IO error.
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
        ...
        /**
         * Removes records which key contains specified url.
         * @param { URLOrString } url - URL or string to match against keys in the cache.
         * @param { URLMatchKind } matchKind - Specifies how the URL should be matched between the record key
         * and the URL in the parameter.
    ...
    /**
     * URL match kind. See {@link ResponseCache.removeMultiple}
     * 'exact' Specifies that the URL should be matched exactly. URL of the matched key should be equal to
     * the provided URL.
     * 'as-substring' Specifies that the URL should be matched as a substring. URL of the matched key should
     * contain the provided URL.
     * @typedef {'exact' | 'as-substring'}
     * @syscap SystemCapability.Collaboration.RemoteCommunication
     * @since 6.0.0(20)
     */
    export type URLMatchKind = 'exact' | 'as-substring';
    /**
     * Creates HTTP response for the specified HTTP request and matched cached response.
     * @param { Request } request - Request to create a response for.
     * @param { CachedResponse } cachedResponse - Cached response.
     * @param { Date } currentTime - Current time.
     * @returns { Response } HTTP Response {@link Response}
     * @syscap SystemCapability.Collaboration.RemoteCommunication
     * @since 6.0.0(20)
     */
    export function createResponse(request: Request, cachedResponse: CachedResponse, currentTime: Date): Response;
    /**
     * Creates cached response {@link CachedResponse} for the specified HTTP response.
     * @param { Response } response - HTTP response to save in cache.
     * @param { Date } [timeStamp] - Cached response time stamp. Current time will be used if omitted.
     * @returns { CachedResponse } Response to save in cache {@link CachedResponse}
     * @syscap SystemCapability.Collaboration.RemoteCommunication
     * @since 6.0.0(20)
     */
    export function createCachedResponse(response: Response, timeStamp?: Date): CachedResponse;
    /**
     * Set the maximum and minimum TLS versions and cipher suites.
     * @interface { TlsVersionRangeOptions }
     * @syscap SystemCapability.Collaboration.RemoteCommunication
     * @since 6.0.0(20)
     */
    export interface TlsVersionRangeOptions {
        /**
         * Minimum TLS version.
         *
         * @type { ?TlsVersion }
        ...
        max?: TlsVersion;
        /**
         * Cipher suites supported within the TLS version range.
         * @type { ?CipherSuite[] }
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 6.0.0(20)
         */
    ...
    /**
     * TLS version.
     * @typedef { 'TlsV1.0' | 'TlsV1.1' | 'TlsV1.2' | 'TlsV1.3' }
     * @syscap SystemCapability.Collaboration.RemoteCommunication
     * @since 6.0.0(20)
     */
