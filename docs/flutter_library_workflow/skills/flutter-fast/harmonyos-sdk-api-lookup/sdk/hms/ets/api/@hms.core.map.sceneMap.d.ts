...
declare namespace sceneMap {
    ...
    interface LocationQueryOptions {
        ...
        siteId?: string;
        /**
         * Set the page language.If not set, will use the system default language.
        ...
        /**
         * Callback when user close the picker dialog.
         *
         * @type { ?Callback<void> }
         * @syscap SystemCapability.Map.Core
         * @stagemodelonly
    ...
    interface DistrictSelectOptions {
        ...
        themeColor?: CustomColors;
        /**
         * Indicates whether to show district select in sub window.
         *
         * @type { ?boolean }
         * @default false
         * @syscap SystemCapability.Map.Core
