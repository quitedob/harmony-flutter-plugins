...
| size | [Size](/consumer/cn/doc/harmonyos-references/arkts-apis-camera-i#size) | 是 | 否 | 分辨率。  设置的是相机的分辨率宽度和高度，而非实际输出图像的宽度和高度。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| previewProfiles | Array<[Profile](/consumer/cn/doc/harmonyos-references/arkts-apis-camera-i#profile)> | 是 | 否 | 支持的预览配置信息集合。 |
| photoProfiles | Array<[Profile](/consumer/cn/doc/harmonyos-references/arkts-apis-camera-i#profile)> | 是 | 否 | 支持的拍照配置信息集合。 |
| videoProfiles | Array<[VideoProfile](/consumer/cn/doc/harmonyos-references/arkts-apis-camera-i#videoprofile)> | 是 | 否 | 支持的录像配置信息集合。 |
...
| outputCapabilities | Array<[CameraOutputCapability](/consumer/cn/doc/harmonyos-references/arkts-apis-camera-i#cameraoutputcapability) > | 是 | 否 | 相机对应模式的输出能力集。 |
...
| location | [Location](/consumer/cn/doc/harmonyos-references/arkts-apis-camera-i#location) | 否 | 是 | 图片地理位置信息（默认以设备硬件信息为准）。 |
...
| boundingBox | [Rect](/consumer/cn/doc/harmonyos-references/arkts-apis-camera-i#rect) | 是 | 否 | metadata 区域框。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| zoomRange | [ZoomRange](/consumer/cn/doc/harmonyos-references/arkts-apis-camera-i#zoomrange24) | 否 | 否 | 特定物理光圈的变焦范围。 |
