...
[ArkGuardAbility.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/ArkTS/ArkTSCompilationToolchain/ArkGuardForSourceCodeObfuscation/ArkGuardObfuscationAbility/entry/src/main/ets/arkguardability/ArkGuardAbility.ts#L31-L49)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9f/v3/nQcGh21cRyWka-LtFlFthA/zh-cn_image_0000002566176764.png?HW-CC-KV=V1&HW-CC-Date=20260507T114703Z&HW-CC-Expire=86400&HW-CC-Sign=8D70222BD96CB37F5C72D2BC618833DFAFB834FD21C93AF8E0C9BACC4FCE0669)
...
| --- | --- |
| 默认混淆 | 开启混淆后生效 |
| 关闭混淆 | [-disable-obfuscation](/consumer/cn/doc/harmonyos-guides/source-obfuscation#section-disable-obfuscation) |
| 开启属性名称混淆 | [-enable-property-obfuscation](/consumer/cn/doc/harmonyos-guides/source-obfuscation#section-enable-property-obfuscation) |
| 开启字符串属性名称混淆 | [-enable-string-property-obfuscation](/consumer/cn/doc/harmonyos-guides/source-obfuscation#section-enable-string-property-obfuscation) |
| 开启顶层作用域名称混淆 | [-enable-toplevel-obfuscation](/consumer/cn/doc/harmonyos-guides/source-obfuscation#section-enable-toplevel-obfuscation) |
| 开启导入导出名称混淆 | [-enable-export-obfuscation](/consumer/cn/doc/harmonyos-guides/source-obfuscation#section-enable-export-obfuscation) |
| 开启文件名混淆 | [-enable-filename-obfuscation](/consumer/cn/doc/harmonyos-guides/source-obfuscation#section-enable-filename-obfuscation) |
| 代码压缩 | [-compact](/consumer/cn/doc/harmonyos-guides/source-obfuscation#section-compact) |
| 声明文件注释删除 | [-remove-comments](/consumer/cn/doc/harmonyos-guides/source-obfuscation#section-remove-comments) |
| 删除console.\*语句 | [-remove-log](/consumer/cn/doc/harmonyos-guides/source-obfuscation#section-remove-log) |
| 名称缓存输出 | [-print-namecache](/consumer/cn/doc/harmonyos-guides/source-obfuscation#section-print-namecache) |
| 名称缓存复用 | [-apply-namecache](/consumer/cn/doc/harmonyos-guides/source-obfuscation#section-apply-namecache) |
| 输出未混淆名单 | [-print-kept-names](/consumer/cn/doc/harmonyos-guides/source-obfuscation#section-print-kept-names) |
| 缩减语言预置白名单 | [-extra-options strip-language-default](/consumer/cn/doc/harmonyos-guides/source-obfuscation#section-extra-options-strip-language-default) |
| 缩减系统预置白名单 | [-extra-options strip-system-api-args](/consumer/cn/doc/harmonyos-guides/source-obfuscation#section-extra-options-strip-system-api-args) |
| 不保留未参与编译模块名称 | [-extra-options strip-not-compiled-module-name](/consumer/cn/doc/harmonyos-guides/source-obfuscation#section-extra-options-strip-not-compiled-module-name) |
| 保留声明文件参数 | [-keep-parameter-names](/consumer/cn/doc/harmonyos-guides/source-obfuscation#section-keep-parameter-names) |
| 合并依赖模块选项 | [-enable-lib-obfuscation-options](/consumer/cn/doc/harmonyos-guides/source-obfuscation#section-enable-lib-obfuscation-options) |
| 通过注释在源码中标记白名单 | [-use-keep-in-source](/consumer/cn/doc/harmonyos-guides/source-obfuscation#section-use-keep-in-source) |
| 保留对象字面量属性名称 | [-keep-object-props](/consumer/cn/doc/harmonyos-guides/source-obfuscation#section-keep-object-props) |
| 删除指定的方法调用语句 | [-remove-nosideeffects-calls](/consumer/cn/doc/harmonyos-guides/source-obfuscation#section-remove-nosideeffects-calls) |
...
[ArkGuardAbility.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/ArkTS/ArkTSCompilationToolchain/ArkGuardForSourceCodeObfuscation/ArkGuardObfuscationAbility/entry/src/main/ets/arkguardability/ArkGuardAbility.ts#L51-L58)
...
* 在未开启-enable-export-obfuscation选项的情况下，被import/export直接导入或导出的类或对象的属性名不会被混淆。例如，下面例子中的属性名data1不会被混淆。
  ...
  [ArkGuardAbility.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/ArkTS/ArkTSCompilationToolchain/ArkGuardForSourceCodeObfuscation/ArkGuardObfuscationAbility/entry/src/main/ets/arkguardability/ArkGuardAbility.ts#L61-L66)
* ArkUI组件中的属性名不会被混淆。例如，下面例子中的message和data不会被混淆。
  ...
  [ArkGuardAbility.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/ArkTS/ArkTSCompilationToolchain/ArkGuardForSourceCodeObfuscation/ArkGuardObfuscationAbility/entry/src/main/ets/arkguardability/ArkGuardAbility.ets#L32-L41)
...
* 字符串字面量属性名不会被混淆，并且与其同名的属性名也不会被混淆。例如，下面例子中的exampleName和exampleAge不会被混淆。
  ...
  [ArkGuardAbility.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/ArkTS/ArkTSCompilationToolchain/ArkGuardForSourceCodeObfuscation/ArkGuardObfuscationAbility/entry/src/main/ets/arkguardability/ArkGuardAbility.ts#L73-L78)
  ...
  [ArkGuardAbility.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/ArkTS/ArkTSCompilationToolchain/ArkGuardForSourceCodeObfuscation/ArkGuardObfuscationAbility/entry/src/main/ets/arkguardability/ArkGuardAbility.ts#L68-L71)
* 注解成员名不会被混淆。例如，下面例子中的authorName和revision不会被混淆。
  ...
  [ArkGuardAbility.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/ArkTS/ArkTSCompilationToolchain/ArkGuardForSourceCodeObfuscation/ArkGuardObfuscationAbility/entry/src/main/ets/arkguardability/ArkGuardAbility.ets#L43-L48)
...
2. SDK API的属性白名单中不包含声明文件中使用的字符串常量值，例如示例中的字符串'ohos.want.action.home'未包含在属性白名单中。
   ...
   [ArkGuardAbility.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/ArkTS/ArkTSCompilationToolchain/ArkGuardForSourceCodeObfuscation/ArkGuardObfuscationAbility/entry/src/main/ets/arkguardability/ArkGuardAbility.ts#L80-L91)
...
[ArkGuardAbility.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/ArkTS/ArkTSCompilationToolchain/ArkGuardForSourceCodeObfuscation/ArkGuardObfuscationAbility/entry/src/main/ets/arkguardability/ArkGuardAbility.ts#L93-L96)
...
[ArkGuardAbility.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/ArkTS/ArkTSCompilationToolchain/ArkGuardForSourceCodeObfuscation/ArkGuardObfuscationAbility/entry/src/main/ets/arkguardability/ArkGuardAbility.ts#L98-L103)
...
[FilenameObfuscationTest.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/ArkTS/ArkTSCompilationToolchain/ArkGuardForSourceCodeObfuscation/ArkGuardObfuscationAbility/entry/src/main/ets/FilenameObfuscationTest/FilenameObfuscationTest.ts#L16-L19)
...
[ArkGuardAbility.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/ArkTS/ArkTSCompilationToolchain/ArkGuardForSourceCodeObfuscation/ArkGuardObfuscationAbility/entry/src/main/ets/arkguardability/ArkGuardAbility.ts#L16-L112)
...
[ArkGuardAbility.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/ArkTS/ArkTSCompilationToolchain/ArkGuardForSourceCodeObfuscation/ArkGuardObfuscationAbility/entry/src/main/ets/arkguardability/ArkGuardAbility.ts#L52-L59)
...
[ArkGuardAbility.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/ArkTS/ArkTSCompilationToolchain/ArkGuardForSourceCodeObfuscation/ArkGuardObfuscationAbility/entry/src/main/ets/arkguardability/ArkGuardAbility.ts#L121-L127)
...
1. 文件顶层的调用。
   ...
   [ArkGuardAbility.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/ArkTS/ArkTSCompilationToolchain/ArkGuardForSourceCodeObfuscation/ArkGuardObfuscationAbility/entry/src/main/ets/arkguardability/ArkGuardAbility.ts#L129-L131)
2. 代码块中的调用。
   ...
   [ArkGuardAbility.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/ArkTS/ArkTSCompilationToolchain/ArkGuardForSourceCodeObfuscation/ArkGuardObfuscationAbility/entry/src/main/ets/arkguardability/ArkGuardAbility.ts#L133-L137)
3. module或namespace中的调用。
   ...
   [ArkGuardAbility.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/ArkTS/ArkTSCompilationToolchain/ArkGuardForSourceCodeObfuscation/ArkGuardObfuscationAbility/entry/src/main/ets/arkguardability/ArkGuardAbility.ts#L139-L144)
4. switch语句中的调用。
   ...
   [ArkGuardAbility.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/ArkTS/ArkTSCompilationToolchain/ArkGuardForSourceCodeObfuscation/ArkGuardObfuscationAbility/entry/src/main/ets/arkguardability/ArkGuardAbility.ts#L146-L160)
...
1. 在编译HAR模块且开启属性混淆的情况下，'enum'白名单将收集enum中的成员名称。
   ...
   [ArkGuardAbility.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/ArkTS/ArkTSCompilationToolchain/ArkGuardForSourceCodeObfuscation/ArkGuardObfuscationAbility/entry/src/main/ets/arkguardability/ArkGuardAbility.ts#L162-L167)
...
2. 在编译HAP/HSP/字节码HAR模块且开启属性混淆的情况下，当enum的成员被初始化时，'enum'白名单会收集初始化表达式中包含的变量名称。
   ...
   [ArkGuardAbility.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/ArkTS/ArkTSCompilationToolchain/ArkGuardForSourceCodeObfuscation/ArkGuardObfuscationAbility/entry/src/main/ets/arkguardability/ArkGuardAbility.ts#L169-L176)
...
[ArkGuardAbility.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/ArkTS/ArkTSCompilationToolchain/ArkGuardForSourceCodeObfuscation/ArkGuardObfuscationAbility/entry/src/main/ets/arkguardability/ArkGuardAbility.ts#L178-L203)
...
[ArkGuardAbility.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/ArkTS/ArkTSCompilationToolchain/ArkGuardForSourceCodeObfuscation/ArkGuardObfuscationAbility/entry/src/main/ets/arkguardability/ArkGuardAbility.ts#L205-L219)
...
[ArkGuardAbility.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/ArkTS/ArkTSCompilationToolchain/ArkGuardForSourceCodeObfuscation/ArkGuardObfuscationAbility/entry/src/main/ets/arkguardability/ArkGuardAbility.ts#L221-L235)
...
[ArkGuardAbility.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/ArkTS/ArkTSCompilationToolchain/ArkGuardForSourceCodeObfuscation/ArkGuardObfuscationAbility/entry/src/main/ets/arkguardability/ArkGuardAbility.ts#L237-L243)
...
[ArkGuardAbility.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/ArkTS/ArkTSCompilationToolchain/ArkGuardForSourceCodeObfuscation/ArkGuardObfuscationAbility/entry/src/main/ets/arkguardability/ArkGuardAbility.ts#L245-L252)
...
[ArkGuardAbility.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/ArkTS/ArkTSCompilationToolchain/ArkGuardForSourceCodeObfuscation/ArkGuardObfuscationAbility/entry/src/main/ets/arkguardability/ArkGuardAbility.ts#L254-L258)
...
[ArkGuardAbility.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/ArkTS/ArkTSCompilationToolchain/ArkGuardForSourceCodeObfuscation/ArkGuardObfuscationAbility/entry/src/main/ets/arkguardability/ArkGuardAbility.ets#L50-L59)
...
[ArkGuardAbility.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/ArkTS/ArkTSCompilationToolchain/ArkGuardForSourceCodeObfuscation/ArkGuardObfuscationAbility/entry/src/main/ets/arkguardability/ArkGuardAbility.ts#L260-L265)
...
[ArkGuardAbility.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/ArkTS/ArkTSCompilationToolchain/ArkGuardForSourceCodeObfuscation/ArkGuardObfuscationAbility/entry/src/main/ets/arkguardability/ArkGuardAbility.ts#L267-L287)
...
| 功能 | 选项 |
| --- | --- |
| 指定保留属性名称 | [-keep-property-name](/consumer/cn/doc/harmonyos-guides/source-obfuscation#section-keep-property-name) |
| 指定保留顶层作用域或导入导出元素名称 | [-keep-global-name](/consumer/cn/doc/harmonyos-guides/source-obfuscation#section-keep-global-name) |
| 指定保留文件/文件夹名称 | [-keep-file-name](/consumer/cn/doc/harmonyos-guides/source-obfuscation#section-keep-file-name) |
| 指定保留注释 | [-keep-comments](/consumer/cn/doc/harmonyos-guides/source-obfuscation#section-keep-comments) |
| 指定保留声明文件中的所有名称 | [-keep-dts](/consumer/cn/doc/harmonyos-guides/source-obfuscation#section-keep-dts) |
| 指定保留源码文件中的所有名称 | [-keep](/consumer/cn/doc/harmonyos-guides/source-obfuscation#section-keep) |
...
[ArkGuardAbility.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/ArkTS/ArkTSCompilationToolchain/ArkGuardForSourceCodeObfuscation/ArkGuardObfuscationAbility/entry/src/main/ets/arkguardability/ArkGuardAbility.ts#L289-L301)
...
[ArkGuardAbility.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/ArkTS/ArkTSCompilationToolchain/ArkGuardForSourceCodeObfuscation/ArkGuardObfuscationAbility/entry/src/main/ets/arkguardability/ArkGuardAbility.ts#L303-L316)
...
[ArkGuardAbility.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/ArkTS/ArkTSCompilationToolchain/ArkGuardForSourceCodeObfuscation/ArkGuardObfuscationAbility/entry/src/main/ets/arkguardability/ArkGuardAbility.ts#L23-L328)
...
[ArkGuardAbility.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/ArkTS/ArkTSCompilationToolchain/ArkGuardForSourceCodeObfuscation/ArkGuardObfuscationAbility/entry/src/main/ets/arkguardability/ArkGuardAbility.ts#L27-L337)
...
[ArkGuardAbility.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/ArkTS/ArkTSCompilationToolchain/ArkGuardForSourceCodeObfuscation/ArkGuardObfuscationAbility/entry/src/main/ets/arkguardability/ArkGuardAbility.ts#L339-L354)
...
[ArkGuardAbility.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/ArkTS/ArkTSCompilationToolchain/ArkGuardForSourceCodeObfuscation/ArkGuardObfuscationAbility/entry/src/main/ets/arkguardability/ArkGuardAbility.ets#L21-L77)
...
[ArkGuardAbility.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/ArkTS/ArkTSCompilationToolchain/ArkGuardForSourceCodeObfuscation/ArkGuardObfuscationAbility/entry/src/main/ets/arkguardability/ArkGuardAbility.ts#L356-L362)
...
[Index.d.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/ArkTS/ArkTSCompilationToolchain/ArkGuardForSourceCodeObfuscation/ArkGuardObfuscationAbility/entry/src/main/cpp/types/libentry/Index.d.ts#L23-L27)
...
[ArkGuardAbility.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/ArkTS/ArkTSCompilationToolchain/ArkGuardForSourceCodeObfuscation/ArkGuardObfuscationAbility/entry/src/main/ets/arkguardability/ArkGuardAbility.ets#L27-L82)
...
[ArkGuardAbility.js](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/ArkTS/ArkTSCompilationToolchain/ArkGuardForSourceCodeObfuscation/ArkGuardObfuscationAbility/entry/src/main/ets/arkguardability/ArkGuardAbility.js#L35-L38)
...
[DynamicImportFile.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/ArkTS/ArkTSCompilationToolchain/ArkGuardForSourceCodeObfuscation/ArkGuardObfuscationAbility/entry/src/main/ets/arkguardability/DynamicImportFile.ts#L16-L19)
...
[ArkGuardAbility.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/ArkTS/ArkTSCompilationToolchain/ArkGuardForSourceCodeObfuscation/ArkGuardObfuscationAbility/entry/src/main/ets/arkguardability/ArkGuardAbility.ts#L364-L371)
...
2. 当编译生成的声明文件中class、function、namespace、enum、struct、interface、module、type及属性的名称被混淆时，该元素上方的JsDoc注释无法通过-keep-comments保留。例如，当在-keep-comments中配置了exportClass时，如果exportClass类名被混淆，其JsDoc注释无法被保留。
   ...
   [ArkGuardAbility.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/ArkTS/ArkTSCompilationToolchain/ArkGuardForSourceCodeObfuscation/ArkGuardObfuscationAbility/entry/src/main/ets/arkguardability/ArkGuardAbility.ts#L373-L378)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/26/v3/CGCImg15Q2aVBasuxZdNFA/zh-cn_image_0000002596776095.png?HW-CC-KV=V1&HW-CC-Date=20260507T114703Z&HW-CC-Expire=86400&HW-CC-Sign=9674DADCBAE352CA6745AA592235CC4768D042A22480C3B3264669D1C9FD9381)
