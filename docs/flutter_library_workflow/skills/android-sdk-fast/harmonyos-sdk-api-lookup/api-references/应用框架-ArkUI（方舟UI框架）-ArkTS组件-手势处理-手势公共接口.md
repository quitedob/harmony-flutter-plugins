...
| 类型 | 说明 |
| --- | --- |
| [EventTargetInfo](/consumer/cn/doc/harmonyos-references/ts-gesture-common#eventtargetinfo12) | 当前触摸识别器对应组件的信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [GestureControl.GestureType](/consumer/cn/doc/harmonyos-references/ts-gesture-common#gesturetype11) | 当前手势识别器的类型。 |
...
| 类型 | 说明 |
| --- | --- |
| [GestureRecognizerState](/consumer/cn/doc/harmonyos-references/ts-gesture-common#gesturerecognizerstate12) | 当前手势识别器的状态。 |
...
| 类型 | 说明 |
| --- | --- |
| [EventTargetInfo](/consumer/cn/doc/harmonyos-references/ts-gesture-common#eventtargetinfo12) | 当前手势识别器对应组件的信息。 |
