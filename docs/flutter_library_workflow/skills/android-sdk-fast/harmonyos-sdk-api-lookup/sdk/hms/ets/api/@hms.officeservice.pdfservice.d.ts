...
declare namespace pdfService {
    ...
    export class BackgroundInfo {
        ...
        opacity: number;
        /**
         * Whether the background is on top of the page.
         * @type { boolean }
         * @syscap SystemCapability.OfficeService.PDFService.Core
         * @since 5.0.0(12)
         */
    ...
    export interface SearchResultData {
        ...
        pageIndex: number;
        /**
         * The rectangle of the search result.
         *
         * @type { PdfRect[] }
         * @syscap SystemCapability.OfficeService.PDFService.Core
         * @since 6.0.1(21)
        ...
        rects: PdfRect[];
        /**
         * The context string of the search result.
         *
         * @type { string }
         * @syscap SystemCapability.OfficeService.PDFService.Core
         * @since 6.0.1(21)
    ...
    /**
     * The options that can control search behavior.
     *
    ...
    export interface SearchOptions {
        /**
         * Indicate which page to begin the search.
         *
         * @type { ?number }
         * @syscap SystemCapability.OfficeService.PDFService.Core
         * @since 6.0.1(21)
        ...
        startIndex?: number;
        /**
         * Indicate which page to stop the search.
         *
         * @type { ?number }
         * @syscap SystemCapability.OfficeService.PDFService.Core
         * @since 6.0.1(21)
        ...
        endIndex?: number;
        /**
         * Indicate whether to match whole word.
         *
         * @type { ?boolean }
         * @syscap SystemCapability.OfficeService.PDFService.Core
         * @since 6.0.1(21)
        ...
        /**
         * Indicate whether to match case.
         *
         * @type { ?boolean }
         * @syscap SystemCapability.OfficeService.PDFService.Core
         * @since 6.0.1(21)
        ...
        isMatchCase?: boolean;
        /**
         * The length of context string.
         *
         * @type { ?number }
         * @syscap SystemCapability.OfficeService.PDFService.Core
         * @since 6.0.1(21)
         */
        contextStringLength?: number;
    }
    /**
     * The callback function that will be invoked when finish searching a page.
     *
     * @typedef { function } SearchKeyCallback
     * @param { SearchResultData[] } results - The search results of the page that was just searched.
     * @returns { boolean } Indicate whether to terminate the search process.
     * @syscap SystemCapability.OfficeService.PDFService.Core
     * @since 6.0.1(21)
     */
    ...
    export class PdfDocument {
        ...
        constructor();
        /**
         * Load a file with a specified file path.
         * @param { string } path - file path.
         * @param { string } [password] - File encryption password.
         * @param { function } [onProgress] - Progress bar callback function.
         ...
         * @returns { boolean } Whether the encryption was successfully.
         * @syscap SystemCapability.OfficeService.PDFService.Core
         * @since 5.0.5(17)
         */
        setPdfPassword(password: string): boolean;
        /**
         * Search keyword in the PDF file.
         *
         * @param { string } text - The keyword will be searched.
         * @param { SearchKeyCallback } listener - The callback to execute after searching a page.
         * @param { SearchOptions } [options] - Search options that will affect the search results.
    ...
    export class PdfAnnotationInfo {
        ...
        creationDate?: Date;
        /**
         * The action of the PDFAnnotation.
         * @type { ?PdfAction }
         * @syscap SystemCapability.OfficeService.PDFService.Core
         * @since 5.1.0(18)
         */
    ...
    /**
     * PDFActionGoTo of a PdfAnnotation.
     * @extends PdfAction
     * @syscap SystemCapability.OfficeService.PDFService.Core
     * @since 5.1.0(18)
     */
    export class PdfActionGoTo extends PdfAction {
        /**
         * the destInfo of PDFAction.
         * @type { DestInfo }
         * @syscap SystemCapability.OfficeService.PDFService.Core
         * @since 5.1.0(18)
         */
    ...
    /**
     * PDFActionHyperlink of a PdfAnnotation.
     * @extends PdfAction
     * @syscap SystemCapability.OfficeService.PDFService.Core
     * @since 5.1.0(18)
     */
    export class PdfActionHyperlink extends PdfAction {
        /**
         * the hyperLink of PDFAction.
         * @type { string }
         * @syscap SystemCapability.OfficeService.PDFService.Core
         * @since 5.1.0(18)
         */
    ...
    export class PixelOptions {
        ...
        constructor();
        /**
         * Describes whether get a gray-only image.
         * @type { ?boolean }
         * @syscap SystemCapability.OfficeService.PDFService.Core
         * @since 5.1.0(18)
         */
        isGray?: boolean;
        /**
         * Describes whether draw the annotations in image.
         * @type { ?boolean }
         * @syscap SystemCapability.OfficeService.PDFService.Core
         * @since 5.1.0(18)
         */
        ...
        /**
         * Describes whether get a transparent image.
         * @type { ?boolean }
         * @syscap SystemCapability.OfficeService.PDFService.Core
         * @since 5.1.0(18)
         */
    ...
    export class PdfPage {
         ...
         * @param { number } bitmapwidth - bitmapwidth, describes the width of the image in page.
         * @param { number } bitmapHeight - bitmapHeight, describes the Height of the image in page.
         * @param { PixelOptions } [options] - options of the image in page.
         * @returns { image.PixelMap } image.PixelMap.
         * @throws { BusinessError } 401 - invalid input parameter.
         * @syscap SystemCapability.OfficeService.PDFService.Core
         * @since 5.1.0(18)
