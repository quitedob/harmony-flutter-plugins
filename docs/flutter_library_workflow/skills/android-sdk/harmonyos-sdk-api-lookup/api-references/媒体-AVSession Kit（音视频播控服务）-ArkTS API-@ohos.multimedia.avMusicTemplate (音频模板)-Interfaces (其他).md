...
媒体标签页内容的定义。继承自[OperResult](/consumer/cn/doc/harmonyos-references/arkts-apis-avmusictemplate-i#operresult)。
...
| compilations | [Compilation](/consumer/cn/doc/harmonyos-references/arkts-apis-avmusictemplate-i#compilation)[] | 否 | 否 | 页面内容的合集数组。 |

## Compilation

合集的定义。继承自[OperResult](/consumer/cn/doc/harmonyos-references/arkts-apis-avmusictemplate-i#operresult)。
...
| topElements | [MediaEntity](/consumer/cn/doc/harmonyos-references/arkts-apis-avmusictemplate-i#mediaentity)[] | 否 | 否 | 合集的内容。 |

## Banner

海报的定义。继承自[MediaEntity](/consumer/cn/doc/harmonyos-references/arkts-apis-avmusictemplate-i#mediaentity)。
...
专辑的定义。继承自[MediaEntity](/consumer/cn/doc/harmonyos-references/arkts-apis-avmusictemplate-i#mediaentity)。
...
| favSubscribeData | [FavoriteData](/consumer/cn/doc/harmonyos-references/arkts-apis-avmusictemplate-i#favoritedata) | 否 | 否 | 收藏或订阅的信息。 |
| episodeCounts | string | 否 | 是 | 专辑的总音频数。 |

## Ranking

排行榜的定义。继承自[MediaEntity](/consumer/cn/doc/harmonyos-references/arkts-apis-avmusictemplate-i#mediaentity)。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| topElements | [MediaEntity](/consumer/cn/doc/harmonyos-references/arkts-apis-avmusictemplate-i#mediaentity)[] | 否 | 否 | 榜单下的推荐歌曲。 |

## MediaEntity

媒体实例的定义。继承自[OperResult](/consumer/cn/doc/harmonyos-references/arkts-apis-avmusictemplate-i#operresult)。
...
| episodeRange | [EpisodeRange](/consumer/cn/doc/harmonyos-references/arkts-apis-avmusictemplate-i#episoderange) | 否 | 是 | 要查询的剧集区间。 |
...
标签页媒体的定义。继承自[OperResult](/consumer/cn/doc/harmonyos-references/arkts-apis-avmusictemplate-i#operresult)。
...
| elements | [MediaEntity](/consumer/cn/doc/harmonyos-references/arkts-apis-avmusictemplate-i#mediaentity)[] | 否 | 否 | 查询数据内容（根据类型传递相应的结构数据）。 |
| sort | [Sort](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-avmusictemplate-e#sort) | 否 | 是 | 数据排序。 |
| episodeRange | [EpisodeRange](/consumer/cn/doc/harmonyos-references/arkts-apis-avmusictemplate-i#episoderange) | 否 | 是 | 剧集区间。 |

## Single

单曲的定义。继承自[MediaEntity](/consumer/cn/doc/harmonyos-references/arkts-apis-avmusictemplate-i#mediaentity)。
...
| playInfo | [PlayInfo](/consumer/cn/doc/harmonyos-references/arkts-apis-avmusictemplate-i#playinfo) | 否 | 否 | 播放歌曲信息。 |
| favSubscribeData | [FavoriteData](/consumer/cn/doc/harmonyos-references/arkts-apis-avmusictemplate-i#favoritedata) | 否 | 否 | 收藏或订阅的歌曲的信息。 |
| tags | string[] | 否 | 是 | 歌曲标签信息的数组。 |
| settings | [SettingItem](/consumer/cn/doc/harmonyos-references/arkts-apis-avmusictemplate-i#settingitem)[] | 否 | 是 | 歌曲设置项的数组。 |
...
| buttons | [DialogButtonInfo](/consumer/cn/doc/harmonyos-references/arkts-apis-avmusictemplate-i#dialogbuttoninfo)[] | 否 | 是 | 对话框按钮的数组。 |
| qrCodes | [QrCodeInfo](/consumer/cn/doc/harmonyos-references/arkts-apis-avmusictemplate-i#qrcodeinfo)[] | 否 | 是 | 对话框二维码的数组。  当设置了二维码信息时，此对话框将被识别为二维码对话框，并将优先显示二维码信息。最多可以设置两个。 |
...
“我的主页”自定义元素的定义。继承自[OperResult](/consumer/cn/doc/harmonyos-references/arkts-apis-avmusictemplate-i#operresult)。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| userInfo | [UserInfo](/consumer/cn/doc/harmonyos-references/arkts-apis-avmusictemplate-i#userinfo) | 否 | 是 | 用户信息。 |
| tabs | [MediaTab](/consumer/cn/doc/harmonyos-references/arkts-apis-avmusictemplate-i#mediatab)[] | 否 | 是 | 标签页信息。 |
| customCompilations | [Compilation](/consumer/cn/doc/harmonyos-references/arkts-apis-avmusictemplate-i#compilation)[] | 否 | 是 | 合集数组。 |
| settings | [SettingItem](/consumer/cn/doc/harmonyos-references/arkts-apis-avmusictemplate-i#settingitem)[] | 否 | 是 | 设置项数组。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| musicInfo | [SearchPlayMusicInfo](/consumer/cn/doc/harmonyos-references/arkts-apis-avmusictemplate-i#searchplaymusicinfo) | 否 | 是 | 搜播的音频信息。 |
| videoInfo | [SearchPlayVideoInfo](/consumer/cn/doc/harmonyos-references/arkts-apis-avmusictemplate-i#searchplayvideoinfo) | 否 | 是 | 搜播的视频信息。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| items | [SearchPlayMusicItem](/consumer/cn/doc/harmonyos-references/arkts-apis-avmusictemplate-i#searchplaymusicitem)[] | 否 | 否 | 音频列表。 |
