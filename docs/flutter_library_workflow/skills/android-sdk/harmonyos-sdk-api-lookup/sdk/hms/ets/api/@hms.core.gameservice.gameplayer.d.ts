...
declare namespace gamePlayer {
    ...
    enum GameErrorCode {
         ...
         * @since 6.0.1(21)
         */
        NOT_MINI_GAME_ERROR = 1002000018,
        /**
         * Parameter error.
         *
         * @syscap SystemCapability.Game.GameService.GamePlayer
         ...
         * @since 6.0.1(21)
         */
        PAY_PRODUCT_INVALID = 1002000050,
        /**
         ...
         * @since 6.0.1(21)
         */
        PAY_PRODUCT_NOT_OWNED = 1002000052,
        /**
         ...
         * @since 6.0.1(21)
         */
        PAY_PRODUCT_CONSUMED = 1002000053,
        /**
         ...
         * @since 6.0.1(21)
         */
        PAY_ACCOUNT_REGION_UNSUPPORTED = 1002000054,
        /**
    ...
    /**
     * Mini game login parameters passed in by developer.
     *
     * @typedef MiniGameLoginParam
     * @syscap SystemCapability.Game.GameService.GamePlayer
     * @since 6.0.1(21)
     */
    interface MiniGameLoginParam {
        /**
         * The appid of the current mini game.
         *
         * @type { string }
         * @syscap SystemCapability.Game.GameService.GamePlayer
         * @since 6.0.1(21)
    ...
    /**
     * Mini game login results returned to developer.
     *
     * @typedef MiniGamePlayer
     * @syscap SystemCapability.Game.GameService.GamePlayer
     * @since 6.0.1(21)
     */
     ...
     * @throws { BusinessError } 1002000010 - The playerId is not current player.
     * @throws { BusinessError } 1002000011 - Agreement not agreed.
     * @throws { BusinessError } 1002000013 - The thirdOpenId and teamPlayerId are not bound.
     * @throws { BusinessError } 1002000017 - Illegal application identity.
     * @syscap SystemCapability.Game.GameService.GamePlayer
     * @since 5.0.0(12)
     */
    ...
    /**
     * Provide the ability to mini game login with Huawei ID
     *
     * @param { common.Context } context - The context of an ability.
     * @param { MiniGameLoginParam} loginParam - The params of mini game login.
     * @returns { Promise<MiniGamePlayer> } Returns MiniGamePlayer.
     * @throws { BusinessError } 1002000001 - System internal error.
     * @throws { BusinessError } 1002000002 - Network connection error.
     * @throws { BusinessError } 1002000003 - The HUAWEI ID is not signed in or not authorized.
     * @throws { BusinessError } 1002000004 - User cancels real name authentication or not real name.
     ...
     * @throws { BusinessError } 1002000008 - The HUAWEI ID is in the blocklist.
     * @throws { BusinessError } 1002000011 - Agreement not agreed.
     * @throws { BusinessError } 1002000018 - This API is only provided for HarmonyOS mini games.
     * @throws { BusinessError } 1002000019 - Parameter error.
     * @syscap SystemCapability.Game.GameService.GamePlayer
     * @since 6.0.1(21)
     */
    function miniGameLogin(context: common.Context, loginParam: MiniGameLoginParam): Promise<MiniGamePlayer>;
    /**
     * Provide the ability to mini game pay
     *
     * @param { common.Context } context - The context of an ability.
     ...
     * @throws { BusinessError } 1002000002 - Network connection error.
     * @throws { BusinessError } 1002000003 - The HUAWEI ID is not signed in or not authorized.
     * @throws { BusinessError } 1002000007 - The application to which the product belongs is not
     *     listed in the specified country.
     * @throws { BusinessError } 1002000018 - This API is only provided for HarmonyOS mini games.
     * @throws { BusinessError } 1002000019 - Parameter error.
     * @throws { BusinessError } 1002000020 - The operation was canceled by the user.
     * @throws { BusinessError } 1002000021 - Too frequent API calls.
     * @throws { BusinessError } 1002000050 - Invalid product information.
     * @throws { BusinessError } 1002000051 - Failed to purchase a product because the user already owns the product.
     * @throws { BusinessError } 1002000052 - The purchase cannot be finished because the user has not paid for it.
     * @throws { BusinessError } 1002000053 - The purchase has been finished and cannot be finished again.
     * @throws { BusinessError } 1002000054 - The country or region of the signed-in HUAWEI ID does not support IAP.
     * @throws { BusinessError } 1002000056 - The user is not allowed to make purchase.
     * @syscap SystemCapability.Game.GameService.GamePlayer
     * @since 6.0.1(21)
     */
    function miniGamePay(context: common.Context, parameter: PurchaseParameter): Promise<CreatePurchaseResult>;
    /**
     * Registering a listening event for game addiction prevented.
     *
     * @param { 'miniGameAddictionPrevented' } type - Type of the event to listen for.
     * @param { Callback<string> } callback - The callback object need to be registered.
     * @throws { BusinessError } 1002000018 - This API is only provided for HarmonyOS mini games.
     * @syscap SystemCapability.Game.GameService.GamePlayer
     * @since 6.0.1(21)
     */
    ...
    /**
     * Unregistering a listening event for game addiction prevented.
     * Note:
     * Callback is an optional parameter. If a callback object is passed in, it means that only the current callback
     * is unregistered. If this parameter is not passed in, it means that all registered callbacks are unregistered
     *
     * @param { 'miniGameAddictionPrevented' } type - Type of the event to listen for.
     * @param { Callback<string> } [callback] - The callback object need to be unregistered.
     * @throws { BusinessError } 1002000018 - This API is only provided for HarmonyOS mini games.
     * @syscap SystemCapability.Game.GameService.GamePlayer
     * @since 6.0.1(21)
     */
