...
[使用Swiper实现图文作品合集](/consumer/cn/doc/best-practices/bpta-carousel-graphic-works#section1461474222812)：图文作品合集由图片和文字组合而成，通过Swiper组件来动态展示图片，实现图片的轮播效果。

[实现轮播图片叠加效果](/consumer/cn/doc/best-practices/bpta-carousel-graphic-works#section45251227153219)：轮播图的叠加效果（多层轮播图视觉叠加）可以创造独特的视觉层次和交互体验。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/32/v3/kLKua1SBRje2H5V1BzlRjg/zh-cn_image_0000002396390305.gif?HW-CC-KV=V1&HW-CC-Date=20260414T055502Z&HW-CC-Expire=86400&HW-CC-Sign=A35F8931C832989A9AB130989AAAEE0CC6F82F0C73415D90ABBBB0453CE31C4D "点击放大")
...
1. 为Swiper组件设置[loop](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#loop)、[autoPlay](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#autoplay)、[interval](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#interval)和[indicator](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#indicator)属性。在手指未滑动的情况下，图片每3秒会进行一次切换，并且自动进行轮播。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b8/v3/rb5ZjVcsQQencDQPMkeJFA/zh-cn_image_0000002362872296.gif?HW-CC-KV=V1&HW-CC-Date=20260414T055502Z&HW-CC-Expire=86400&HW-CC-Sign=9D11DC2B6C333A0B2E181B11D847A1E69222AAEC24EEAB8C3BDDCBBF556B001F)
2. 创建进度条自定义组件progressComponent。代码中，this.progressData为图片集合的数组，this.currentIndex为当前播放的图片在图片集合数组中的索引，index为进度条对应的图片在图片集合数组中的索引。当this.currentIndex > index时，表示图片集合数组中索引0-index的进度条都是已完成状态。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6e/v3/70Q6Q5wgSp65jN88tvIbVw/zh-cn_image_0000002396272325.gif?HW-CC-KV=V1&HW-CC-Date=20260414T055502Z&HW-CC-Expire=86400&HW-CC-Sign=6D313DBEC81C9AADF94C63B8FA5BD5EE80FA516E929C0BADF3A2789A057C231A)
3. 滑动切换图片后，关闭自动轮播与循环轮播。此时，开发者需要给Swiper组件添加[onGestureSwipe](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#ongestureswipe10)事件，来判断页面是否跟手滑动。其中slide为布尔值，用来判断页面是否跟手滑动。默认值为false，当页面跟手滑动时，slide的值为true。当进行滑动切换时，autoPlay、loop属性的取值为false，即关闭自动轮播与循环播放功能。若想实现滑动图片后仍自动循环轮播，直接去掉slide相关代码片段即可。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/dd/v3/JXfVqNS_QOmE6osddxOFfQ/zh-cn_image_0000002362712392.gif?HW-CC-KV=V1&HW-CC-Date=20260414T055502Z&HW-CC-Expire=86400&HW-CC-Sign=587143936ECCC3B7E5DE1B7F985C5784C71128F46A09DACE31C8EE0BC20EE3F9 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/43/v3/U0E7VKc8QiKoq8t4MaOUXg/zh-cn_image_0000002362716188.gif?HW-CC-KV=V1&HW-CC-Date=20260414T055502Z&HW-CC-Expire=86400&HW-CC-Sign=0913C38E423F31FFEC1D2AEE2A2503A7B649BA35DC826D3707472748C9913AD5 "点击放大")
