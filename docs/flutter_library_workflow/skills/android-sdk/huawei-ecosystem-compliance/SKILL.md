...
coding 阶段从 `01-analysis.json.ecosystem_compliance` 识别 mandatory 能力，再按下表读取具体指南。Android SDK 转 HAR 场景只参考指南中的 HarmonyOS Kit/API/配置和 ArkTS 服务封装，不要照搬 Flutter wrapper、MethodChannel 或 Dart 层示例。
