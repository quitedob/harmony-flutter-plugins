...
declare namespace customScan {
    ...
    /**
     * Get flash status.
     * @returns { boolean } Returns {@code true} if the flashlight is open; returns {@code false} otherwise.
     * @throws { BusinessError } 1000500001 - Internal error.
     * @syscap SystemCapability.Multimedia.Scan.ScanBarcode
     * @since 4.1.0(11)
     */
    ...
    /**
     * Sets whether to enable auto zoom. Auto zoom is enabled by default.
     * @param { boolean } enabled - Whether to enable auto zoom. The value true means to enable auto zoom, and false means to disable it.
     * @throws { BusinessError } 1000500001 - Internal error.
     * @syscap SystemCapability.Multimedia.Scan.ScanBarcode
     * @since 5.1.0(18)
     */
    function setAutoZoomEnabled(enabled: boolean): void;
}
