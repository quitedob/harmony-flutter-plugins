...
| permissions | Array<string> | 是 | 否 | 访问应用程序所需的权限。  通过调用[bundle.getApplicationInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-bundle#bundlegetapplicationinfodeprecated)接口时，传入GET\_APPLICATION\_INFO\_WITH\_PERMISSION获取。 |
