...
本目录与 `agent-android-sdk/.claude/skills/ohos-sdk-code-review/scripts/` 同源（方案 A 复制落地，仅 ETS 机械扫描通用，跨 agent 各持一份）。
完整设计文档见 `agent-android-sdk/.claude/skills/ohos-sdk-code-review/docs/hybrid-code-scan-design.md`。
