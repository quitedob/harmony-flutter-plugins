...
| ERR\_DURATION\_OUT\_OF\_RANGE23+ | -6 | 在[BlanklessLoadingParam](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-webview-i#blanklessloadingparam23)设置的插帧持续时间超出范围。  **模型约束：** 此接口仅可在Stage模型下使用。 |
| ERR\_EXPIRATION\_TIME\_OUT\_OF\_RANGE23+ | -7 | 在[BlanklessLoadingParam](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-webview-i#blanklessloadingparam23)设置的历史帧失效时间超出范围。  **模型约束：** 此接口仅可在Stage模型下使用。 |
