...
declare namespace map {
    ...
    class MapComponentController {
         ...
         */
        /**
         * Adds a Marker to a map. The icon of the Marker will be displayed in the Marker location on the map.
         * When the Marker is tapped, the camera moves around the Marker.
         *
         * @param { mapCommon.MarkerOptions } options  - Marker attributes.
         * @returns { Promise<Marker> } Return the marker object.
         * @throws { BusinessError } 401 - Invalid input parameter.
         * @throws { BusinessError } 1002601001 - The object to be operated does not exist.
         * @throws { BusinessError } 1002601005 - Failed to generate the icon of the customized component.
         * @syscap SystemCapability.Map.Core
         * @stagemodelonly
         * @atomicservice
         * @since 6.0.0(20)
         ...
         * Adds a TileOverlay.
         *
         * @param { mapCommon.TileOverlayParams } params - TileOverlay parameters.
        ...
        /**
         * Adds a TileOverlay.
         * @param { mapCommon.TileOverlayParams | mapCommon.TileOverlayOptions } params - TileOverlay input
         * parameters.
         * @returns { TileOverlay } TileOverlay.
         * @throws { BusinessError } 1002601001 - The object to be operated does not exist.
         * @syscap SystemCapability.Map.Core
         * @stagemodelonly
         * @atomicservice
         ...
         * Adds a heatmap.
         *
         * @param { mapCommon.HeatmapParams } params  - Heatmap parameters.
         * @returns { Promise<Heatmap> } Heatmap object.
         * @throws { BusinessError } 1002601001 - The object to be operated does not exist.
         * @throws { BusinessError } 1002600015 - The heatmap ID already exists.
         * @syscap SystemCapability.Map.Core
         * @stagemodelonly
         * @atomicservice
         * @since 6.0.0(20)
        ...
        /**
         * Switches between 2D and 3D animations.
         * @param { boolean } enabled  - Switching to the 2D or 3D animation.
         * @param { number } animateDuration  - Animation duration, in milliseconds.
         * @syscap SystemCapability.Map.Core
         * @stagemodelonly
         * @atomicservice
         * @since 6.0.0(20)
        ...
        /**
         * Adds an MvtOverlay.
         * @param { mapCommon.MvtOverlayParams } params  - MvtOverlay input parameters.
         * @returns { MvtOverlay } MvtOverlay.
         * @throws { BusinessError } 1022100001  - The operation object does not exist.
        ...
        /**
         * Adds a FlowFieldOverlay.
         * @param { mapCommon.FlowFieldOverlayParams } params  - FlowFieldOverlay input parameters.
         * @returns { Promise<FlowFieldOverlay> } Return FlowFieldOverlay.
         * @throws { BusinessError } 1022100001  - The operation object does not exist.
         * @syscap SystemCapability.Map.Core.EnhancedOverlay
         * @stagemodelonly
         * @atomicservice
        ...
        /**
         * Adds a MassPointOverlay.
         * @param { mapCommon.MassPointOverlayParams } params  - MassPointOverlay input parameters.
         * @returns { Promise<MassPointOverlay> } MassPointOverlay.
         * @throws { BusinessError } 1002601001 - The object to be operated does not exist.
         * @syscap SystemCapability.Map.Core
         * @stagemodelonly
         * @atomicservice
        ...
        /**
         * Returns the map language.
         * @returns { string } Map language.
         * @syscap SystemCapability.Map.Core
         * @stagemodelonly
         * @atomicservice
         * @since 6.0.0(20)
        ...
        getLanguage(): string;
        /**
         * Adjusts the position of the my-location layer relative to an overlay.
         * @param { boolean } isBelow - The value <b class="+ topic/ph hi-d/b " id="b1388918311006">true</b>
         * indicates that the overlay is on top of the my-location layer.
         * The value <b class="+ topic/ph hi-d/b " id="b135251916418">false</b> indicates that the my-location
         * layer is on top of the overlay.
         * @syscap SystemCapability.Map.Core
         * @stagemodelonly
         * @atomicservice
         * @since 6.0.1(21)
    ...
    interface Marker extends BaseOverlay {
        ...
        /**
         * Sets a custom component for generating Marker icons.
         * @param { CustomBuilder } iconBuilder  - Custom component.
         * @returns { Promise<void> }
         * @throws { BusinessError } 1002601005  - Failed to generate the icon of the custom component.
         * @syscap SystemCapability.Map.Core
         * @stagemodelonly
         * @atomicservice
         * @since 6.0.0(20)
    ...
    interface MapEventManager {
        ...
        /**
         * Listens for MassPointOverlay tap events.
         * @param { 'massPointOverlayClick' } type
         * @param { MassPointOverlayCallback } callback - Listening for MassPointOverlay tap events.
         * @syscap SystemCapability.Map.Core
         * @stagemodelonly
         * @atomicservice
         * @since 6.0.0(20)
        ...
        /**
         * Cancels listening for MassPointOverlay tap events.
         * @param { 'massPointOverlayClick' } type
         * @param { MassPointOverlayCallback } [callback] - Canceling listening for MassPointOverlay tap events.
         * @syscap SystemCapability.Map.Core
         * @stagemodelonly
         * @atomicservice
         * @since 6.0.0(20)
    ...
    interface TileOverlay extends BaseOverlay {
        ...
        getFadeIn(): boolean;
        /**
         * Clears the disk cache. The memory cache is also cleared.
         * @returns { Promise<void> }
         * @syscap SystemCapability.Map.Core
         * @stagemodelonly
         * @atomicservice
    ...
    interface Heatmap {
        /**
         * Updates and resets the heatmap data.
         * @param { mapCommon.WeightedLatLng[] } data - Heatmap data.
         * @syscap SystemCapability.Map.Core
         * @stagemodelonly
         * @atomicservice
         * @since 6.0.0(20)
         ...
         * @returns { mapCommon.WeightedLatLng[] } Heatmap data.
         * @syscap SystemCapability.Map.Core
         * @stagemodelonly
         * @atomicservice
         * @since 6.0.0(20)
        ...
        /**
         * Updates the heatmap color.
         * @param { Record<number, number> } color - Heatmap color.
         * @syscap SystemCapability.Map.Core
         * @stagemodelonly
         * @atomicservice
         * @since 6.0.0(20)
         ...
         * @returns { Record<number, number> } Heatmap color.
         * @syscap SystemCapability.Map.Core
         * @stagemodelonly
         * @atomicservice
         * @since 6.0.0(20)
        ...
        /**
         * Updates the heatmap intensity.
         * @param { number | Record<number, number> } intensity - Heatmap intensity.
         * @syscap SystemCapability.Map.Core
         * @stagemodelonly
         * @atomicservice
         * @since 6.0.0(20)
        ...
        /**
         * Returns the heatmap intensity.
         *
         * @returns { number | Record<number, number> } Heatmap intensity.
         * @syscap SystemCapability.Map.Core
         * @stagemodelonly
         * @atomicservice
         * @since 6.0.0(20)
        ...
        /**
         * Updates the heatmap opacity.
         * @param { number | Record<number, number> } opacity - Heatmap opacity.
         * @syscap SystemCapability.Map.Core
         * @stagemodelonly
         * @atomicservice
         * @since 6.0.0(20)
         ...
         * @returns { number | Record<number, number> } Heatmap opacity.
         * @syscap SystemCapability.Map.Core
         * @stagemodelonly
         * @atomicservice
         * @since 6.0.0(20)
        ...
        /**
         * Updates the heatmap radius.
         * @param { number | Record<number, number> } radius - Heatmap radius.
         * @syscap SystemCapability.Map.Core
         * @stagemodelonly
         * @atomicservice
         * @since 6.0.0(20)
        ...
        /**
         * Returns the heatmap radius.
         * @returns { number | Record<number, number> } Heatmap radius.
         * @syscap SystemCapability.Map.Core
         * @stagemodelonly
         * @atomicservice
         * @since 6.0.0(20)
        ...
        /**
         * Updates the unit of the heatmap radius.
         * @param { mapCommon.RadiusUnit } radiusUnit - Heatmap radius unit.
         * @syscap SystemCapability.Map.Core
         * @stagemodelonly
         * @atomicservice
         * @since 6.0.0(20)
        ...
        /**
         * Returns the unit of the heatmap radius.
         * @returns { mapCommon.RadiusUnit } Heatmap radius unit.
         * @syscap SystemCapability.Map.Core
         * @stagemodelonly
         * @atomicservice
         * @since 6.0.0(20)
        ...
        /**
         * Sets whether the heatmap is visible.
         * @param { boolean } visible - Whether the heatmap is visible.
         * @syscap SystemCapability.Map.Core
         * @stagemodelonly
         * @atomicservice
         * @since 6.0.0(20)
         ...
         * @returns { boolean } Whether the heatmap is visible.
         * @syscap SystemCapability.Map.Core
         * @stagemodelonly
         * @atomicservice
         * @since 6.0.0(20)
     ...
     * @since 6.0.0(20)
     */
    interface MvtOverlay extends BaseOverlay {
        /**
         * Adds layers.
         * @param { mapCommon.MvtLayer[] } layers  - New layers.
         * @syscap SystemCapability.Map.Core.EnhancedOverlay
         * @stagemodelonly
         * @atomicservice
         * @since 6.0.0(20)
        ...
        /**
         * Deletes layers.
         * @param { string[] } layerIds  - IDs of layers to be deleted.
         * @syscap SystemCapability.Map.Core.EnhancedOverlay
         * @stagemodelonly
         * @atomicservice
         * @since 6.0.0(20)
        ...
        /**
         * Adds and deletes layers at the same time.
         * @param { mapCommon.MvtLayer[] } addedLayers  - Layers to be added.
         * @param { string[] } removedLayerIds  - IDs of layers to be deleted.
         * @syscap SystemCapability.Map.Core.EnhancedOverlay
         * @stagemodelonly
         * @atomicservice
         * @since 6.0.0(20)
     ...
     * FlowFieldOverlay.
     * @extends BaseOverlay
     * @typedef FlowFieldOverlay
     * @syscap SystemCapability.Map.Core.EnhancedOverlay
     * @stagemodelonly
     * @atomicservice
     * @since 6.0.0(20)
     */
    interface FlowFieldOverlay extends BaseOverlay {
        /**
         * Sets particle style.
         * @param { mapCommon.ParticleStyle } style - Particle style.
         * @syscap SystemCapability.Map.Core.EnhancedOverlay
         * @stagemodelonly
         * @atomicservice
         * @since 6.0.0(20)
        ...
        /**
         * Returns the particle style.
         * @returns { mapCommon.ParticleStyle } Particle style.
         * @syscap SystemCapability.Map.Core.EnhancedOverlay
         * @stagemodelonly
         * @atomicservice
         * @since 6.0.0(20)
    ...
    interface MassPointOverlay {
        ...
        getId(): string;
        /**
         * Updates the MassPointItem list.
         * @param { mapCommon.MassPointItem[] } items - MassPointItem list.
         * @syscap SystemCapability.Map.Core
         * @stagemodelonly
         * @atomicservice
         * @since 6.0.0(20)
        ...
        /**
         * Returns the MassPointItem list.
         * @returns { mapCommon.MassPointItem[] } MassPointItem list.
         * @syscap SystemCapability.Map.Core
         * @stagemodelonly
         * @atomicservice
         * @since 6.0.0(20)
        ...
        /**
         * Updates the position of an icon anchor in the horizontal direction.
         * @param { number } anchorU - AnchorU
         * @syscap SystemCapability.Map.Core
         * @stagemodelonly
         * @atomicservice
         * @since 6.0.0(20)
        ...
        /**
         * Returns the position of an icon anchor in the horizontal direction.
         * @returns { number } AnchorU
         * @syscap SystemCapability.Map.Core
         * @stagemodelonly
         * @atomicservice
         * @since 6.0.0(20)
        ...
        getAnchorU(): number;
        /**
         * Updates the position of an icon anchor in the vertical direction.
         * @param { number } anchorV - AnchorV
         * @syscap SystemCapability.Map.Core
         * @stagemodelonly
         * @atomicservice
         * @since 6.0.0(20)
        ...
        /**
         * Returns the position of an icon anchor in the vertical direction.
         * @returns { number } AnchorV
         * @syscap SystemCapability.Map.Core
         * @stagemodelonly
         * @atomicservice
         * @since 6.0.0(20)
        ...
        getAnchorV(): number;
        /**
         * Updates whether a MassPointOverlay is visible.
         * @param { boolean } visible - Whether a MassPointOverlay is visible.
         * @syscap SystemCapability.Map.Core
         * @stagemodelonly
         * @atomicservice
         * @since 6.0.0(20)
        ...
        setVisible(visible: boolean): void;
        /**
         * Returns whether a MassPointOverlay is visible.
         * @returns { boolean } Whether a MassPointOverlay is visible.
         * @syscap SystemCapability.Map.Core
         * @stagemodelonly
         * @atomicservice
         * @since 6.0.0(20)
    ...
    /**
     * MassPointOverlay callback function.
     * @typedef { function } MassPointOverlayCallback
     * @param { MassPointOverlay } massPointOverlay - Tapped MassPointOverlay.
     * @param { mapCommon.MassPointItem } massPointItem - Tapped MassPointItem.
     * @syscap SystemCapability.Map.Core
     * @stagemodelonly
     * @atomicservice
     * @since 6.0.0(20)
