...
基于[文件选择器(startAbility)](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/file-processing-apps-startup)的分享方式，应用可分享单个文件，通过[ohos.app.ability.wantConstant的wantConstant.Flags接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-wantconstant#flags)以只读或读写权限授权给其他应用。被分享应用可通过[fs.open](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fsopen)打开URI，并进行读写操作。
