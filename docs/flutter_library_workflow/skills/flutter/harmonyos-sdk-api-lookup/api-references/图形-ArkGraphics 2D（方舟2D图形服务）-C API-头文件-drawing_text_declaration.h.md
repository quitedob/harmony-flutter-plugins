...
| [OH\_Drawing\_FontVariationAxis](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-oh-drawing-fontvariationaxis) | OH\_Drawing\_FontVariationAxis | 用于描述字体可变轴。 |
| [OH\_Drawing\_FontVariationInstance](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-oh-drawing-fontvariationinstance) | OH\_Drawing\_FontVariationInstance | 用于描述字体可变实例，存放预设的可变字体样式信息。 |