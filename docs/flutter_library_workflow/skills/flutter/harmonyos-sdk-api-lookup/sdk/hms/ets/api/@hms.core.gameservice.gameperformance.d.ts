...
declare namespace gamePerformance {
    ...
    interface BaseGameInfo {
         ...
         * 4: Indicates a game player info, corresponding to GamePlayerInfo.
         *
         * @type { number }
         * @syscap SystemCapability.GameService.GamePerformance
         * @since 5.0.0(12)
     ...
     * @throws { BusinessError } 1010300002 - Auth failed.
     * @syscap SystemCapability.GameService.GamePerformance
     * @since 5.0.0(12)
     */
    ...
    /**
     * Enumerates the game custom tag.
     *
     * @enum { number }
     * @syscap SystemCapability.GameService.GamePerformance
     * @since 5.1.0(18)
    ...
    /**
     * Add game custom data with tag.
     *
     * @param { Record<string, string> } data
     * @param { GameCustomTag } tag
     * @throws { BusinessError } 401 - Parameter error. Possible causes: 3. Parameter verification failed.
     * @throws { BusinessError } 1010300003 - Invalid request.
     * @syscap SystemCapability.GameService.GamePerformance
     * @since 5.1.0(18)
     */
    function addGameCustomData(data: Record<string, string>, tag: GameCustomTag): void;
}
