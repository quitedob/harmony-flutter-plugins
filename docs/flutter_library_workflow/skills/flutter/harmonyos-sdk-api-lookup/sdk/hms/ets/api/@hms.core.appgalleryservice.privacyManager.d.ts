...
declare namespace privacyManager {
    ...
    export interface AppPrivacyLink {
        ...
        readonly id: string;
        /**
         * Indicates privacy name of this privacy manage information.
         *
         * @type { string }
         * @readonly
         * @syscap SystemCapability.AppGalleryService.PrivacyManager
    ...
    export interface AppPrivacyResult {
        ...
        readonly id: string;
        /**
         * Indicates privacy signing timestamp.
         *
         * @type { ?number }
         * @readonly
         * @syscap SystemCapability.AppGalleryService.PrivacyManager
         ...
         * @since 5.0.2(14)
         */
        readonly signingTimestamp?: number;
    }
    /**
     * Consent result.
     *
     * @typedef ConsentResult
     * @syscap SystemCapability.AppGalleryService.PrivacyManager
     * @stagemodelonly
     * @since 5.0.2(14)
     */
    export interface ConsentResult {
        /**
         * Indicates app privacy result of consent.
         *
         * @type { AppPrivacyResult[] }
         * @readonly
         * @syscap SystemCapability.AppGalleryService.PrivacyManager
         * @stagemodelonly
         * @since 5.0.2(14)
         */
        readonly results: AppPrivacyResult[];
    }
    /**
    ...
    /**
     * Request app privacy consent.
     * @param { common.UIAbilityContext } context - Indicates the uiAbility context of the media application.
     * @returns { Promise<ConsentResult> } - Consent reult.
     ...
     * @since 5.0.2(14)
     */
    function requestAppPrivacyConsent(context: common.UIAbilityContext): Promise<ConsentResult>;
}
