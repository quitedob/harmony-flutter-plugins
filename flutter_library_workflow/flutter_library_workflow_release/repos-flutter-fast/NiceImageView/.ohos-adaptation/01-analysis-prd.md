...
> 本清单与 `05-test-cases.xlsx`（24 条）及 OHOS Demo（`example_auto/lib/pages/testcase_*.dart`）用例编号、名称、级别完全一致。

| 用例编号 | 用例名称 | 级别 | 所属模块 |
|---------|---------|------|---------|
| F-01-01 | 默认参数构建 | L0 | F-01 构造函数与初始化 |
| F-01-02 | 全参数构建 | L0 | F-01 构造函数与初始化 |
| F-01-03 | 自定义尺寸 | L0 | F-01 构造函数与初始化 |
| F-02-01 | 圆形模式渲染 | L1 | F-02 圆形展示模式 |
| F-02-02 | 圆形模式不崩溃 | L0 | F-02 圆形展示模式 |
| F-03-01 | 统一圆角渲染 | L1 | F-03 圆角半径控制 |
| F-03-02 | 独立圆角渲染 | L1 | F-03 圆角半径控制 |
| F-03-03 | 圆角加边框 | L1 | F-03 圆角半径控制 |
| F-04-01 | 外边框绘制 | L1 | F-04 边框绘制 |
| F-04-02 | 内边框绘制 | L1 | F-04 边框绘制 |
| F-04-03 | 矩形模式忽略内边框 | L2 | F-04 边框绘制 |
| F-05-01 | 边框覆盖图片 | L1 | F-05 边框覆盖控制 |
| F-06-01 | 遮罩叠加绘制 | L1 | F-06 遮罩绘制 |
| F-07-01 | 图片变更触发重绘 | L0 | F-07 重绘逻辑 |
| F-07-02 | 无变更不触发重绘 | L0 | F-07 重绘逻辑 |
| F-07-03 | 圆形属性变更重绘 | L0 | F-07 重绘逻辑 |
| F-07-04 | 边框宽度变更重绘 | L0 | F-07 重绘逻辑 |
| F-07-05 | 圆角半径变更重绘 | L0 | F-07 重绘逻辑 |
| F-07-06 | 遮罩颜色变更重绘 | L0 | F-07 重绘逻辑 |
| F-08-01 | 空图片渲染 | L2 | F-08 边界条件 |
| F-08-02 | 零边框宽度 | L2 | F-08 边界条件 |
| F-08-03 | 零尺寸渲染 | L2 | F-08 边界条件 |
| F-08-04 | 透明遮罩无效果 | L2 | F-08 边界条件 |
| F-08-05 | 默认值验证 | L0 | F-08 边界条件 |
