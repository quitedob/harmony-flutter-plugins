...
**核心职责**：
- 执行两方比对校验（模块数、用例总数、级别分布、模块级用例数），确保测试点与测试用例 100% 一致
...
> **详细说明**：执行前读取 `../../agent-android-sdk/.claude/skills/03-sdk-case-review/SKILL.md` 全文。
...
```
1. Read `../../agent-android-sdk/.claude/skills/03-sdk-case-review/SKILL.md` → 完整方法论、检查清单
2. Read `../../agent-android-sdk/.claude/skills/03-sdk-case-review/references/review-guide.md` → 评审检查清单 + 评分标准
```
...
**评审检查清单+评分标准**：详见 `../../agent-android-sdk/.claude/skills/03-sdk-case-review/references/review-guide.md`（第二节检查清单 + 第三节评分标准 + 第四节通过标准 + 第五节评审结论）。
...
2. 读取 `../../agent-android-sdk/.claude/skills/03-sdk-case-review/assets/review-report-template.md` → 评审报告模板
...
> **校验代码**：`python ../../agent-android-sdk/.claude/skills/03-sdk-case-review/scripts/verify_test_cases.py .ohos-adaptation`（不要用内联命令）
> **校验失败**：任何一项不一致，评审直接判定为**不通过**。
...
> **报告模板**：`../../agent-android-sdk/.claude/skills/03-sdk-case-review/assets/review-report-template.md`
...
| 资源 | 路径 |
|------|------|
| Skill 说明 | `../../agent-android-sdk/.claude/skills/03-sdk-case-review/SKILL.md` |
| 评审指南 | `../../agent-android-sdk/.claude/skills/03-sdk-case-review/references/review-guide.md` |
| 两方验证代码 | `../../agent-android-sdk/.claude/skills/03-sdk-case-review/references/two-way-verification.md` |
| 报告模板 | `../../agent-android-sdk/.claude/skills/03-sdk-case-review/assets/review-report-template.md` |
| JSON Schema | `../../agent-android-sdk/.claude/skills/03-sdk-case-review/assets/case-review-schema.json` |
