...
├── 06-confrontation.json     # 阶段 25 产物：安卓意图验证结构化结果
├── 06-confrontation-report.md# 阶段 25 产物：安卓意图验证报告（人类可读）
├── 04-test-cases-revised.json # 阶段 25 产物：意图验证后修订的测试用例
├── ...（测试路径产物）
├── 01-test-points.json       # 阶段 21 产物：测试点汇总
├── 01-test-analysis-report.md# 阶段 21 产物：测试分析报告
├── 03-case-review-report.md  # 阶段 23 产物：用例评审报告
├── 04-test-cases.json        # 阶段 22/25 产物：测试用例（阶段 25 可能修订）
...
| `json-schema/16-confrontation.schema.json` | `06-confrontation.json` | sdk-case-confrontation（Android 源码意图验证） |
...
| **sdk-case-confrontation** | `json-schema/16-confrontation.schema.json` | `06-confrontation-report.md` 按 prompt 生成 |
