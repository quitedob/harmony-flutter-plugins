...
| 手机拉起穿戴设备侧应用 | 手机侧三方App调用[startRemoteApp](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/wearengine_api#section169404201361)接口拉起穿戴设备侧三方App。 | 接口调用成功，能够拉起穿戴设备侧应用，接口调用返回码201或202。 |
