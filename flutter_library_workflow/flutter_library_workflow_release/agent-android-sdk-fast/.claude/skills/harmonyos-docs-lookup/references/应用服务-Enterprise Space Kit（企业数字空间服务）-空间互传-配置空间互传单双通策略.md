...
| 接口名 | 描述 |
| --- | --- |
| [policyPush](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/enterprisespace-spacedatatransfer#section153991131799)(policyContext: string): void | 配置空间互传单双通策略。 |
