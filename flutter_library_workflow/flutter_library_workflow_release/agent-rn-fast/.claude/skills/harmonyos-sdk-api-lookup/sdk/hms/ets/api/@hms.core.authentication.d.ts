...
declare namespace authentication {
    ...
    export class AuthorizationWithHuaweiIDRequest extends AuthenticationRequest {
        ...
        idTokenSignAlgorithm?: IdTokenSignAlgorithm;
        /**
         * Allows the atomic service to obtain the HUAWEI ID avatar and nickname through the profile scope.
         * @type { ?boolean }
         * @default false
         * @syscap SystemCapability.AuthenticationServices.HuaweiID.Auth
         * @stagemodelonly
    ...
    export class HuaweiIDProvider extends AuthenticationProvider {
         ...
         * @throws { BusinessError } 401 - Parameter error. Possible causes:
         * 1. Mandatory parameters are left unspecified; 2. Incorrect parameter types; 3. Parameter verification failed.
         * @throws { BusinessError } 801 - Capability not supported. Function getMobileNumberConsistency can not work correctly due to limited device capabilities.
         * @throws { BusinessError } 1001500001 - Failed to check the fingerprint of the app bundle.
         * @throws { BusinessError } 1001500004 - The account does not support this function.
         * @throws { BusinessError } 1001500005 - This function is restricted from being called.
         * @throws { BusinessError } 1001502001 - The user has not logged in with HUAWEI ID.
