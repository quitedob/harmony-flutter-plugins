鸿蒙支付服务接入Skill是一套面向开发者/外部商户，基于Payment Kit文档沉淀标准流程与关键校验点，将“文档阅读”转化为“任务清单执行”，帮助开发者更快完成鸿蒙支付服务接入的能力。
...
[下载Skill](https://gitcode.com/HarmonyOS_Samples/paymentkit-sample-code-serverdemo-java/tree/master/skills)，把 Skill 放到AI编码工具的 skills 目录（不同工具规范不一致，按工具要求处理），工具就能在对话中自动或按需使用。
