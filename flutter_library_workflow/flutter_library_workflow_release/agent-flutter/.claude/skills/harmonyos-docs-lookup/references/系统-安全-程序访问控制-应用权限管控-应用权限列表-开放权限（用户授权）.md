...
1. 在“module.json5”配置文件中[声明权限](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/declare-permissions)。
   ...
   * 申请前台模糊位置权限：声明权限[ohos.permission.APPROXIMATELY\_LOCATION](/consumer/cn/doc/harmonyos-guides/permissions-for-all-user#ohospermissionapproximately_location)。
   * 申请前台精确位置权限：同时声明权限[ohos.permission.APPROXIMATELY\_LOCATION](/consumer/cn/doc/harmonyos-guides/permissions-for-all-user#ohospermissionapproximately_location)和[ohos.permission.LOCATION](/consumer/cn/doc/harmonyos-guides/permissions-for-all-user#ohospermissionlocation)。
...
**申请条件**：需要与模糊位置权限[ohos.permission.APPROXIMATELY\_LOCATION](/consumer/cn/doc/harmonyos-guides/permissions-for-all-user#ohospermissionapproximately_location)一起，才可申请此权限。
