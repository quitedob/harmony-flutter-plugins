...
5. static OH_Crypto_ErrCode doTestAesWrap()
6. {
...
16. uint8_t iv[8] = {1, 2, 4, 12, 3, 4, 2, 3}; // 示例代码iv值，开发者可使用安全随机数生成。
...
33. }
34. // 设置参数。
35. ret = OH_CryptoSymCipherParams_SetParam(params, CRYPTO_IV_DATABLOB, &ivBlob); // aes-wrap只需要设置iv。
36. if (ret != CRYPTO_SUCCESS) {
37. goto end;
38. }

40. // 加密。
41. ret = OH_CryptoSymCipher_Create("AES128-WRAP", &encCtx);
...
54. // 解密。
55. ret = OH_CryptoSymCipher_Create("AES128-WRAP", &decCtx);
