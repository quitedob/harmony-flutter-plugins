...
declare namespace healthStore {
     ...
     * Define the type for field value.
     *
     * @typedef { number | string | boolean | undefined }
     * @syscap SystemCapability.Health.HealthStore
     * @atomicservice
     * @since 6.0.1(21)
     */
     ...
     *
     * @extends Record<string, HealthValueType | PaceValueType>
     ...
     * it uses one or more fields to describe the data.
     *
     * @extends Record<string, HealthValueType>
     ...
     *
     * @extends Omit<DataReadRequest, 'startLocalDate' | 'endLocalDate'>
     ...
     *
     * @extends Omit<DataReadRequest, 'startTime' | 'endTime'>
     ...
     *
     * @extends Omit<SampleDataBase, 'dataSourceId'>
     ...
     *
     * @extends Omit<DataRequest, 'startLocalDate' | 'endLocalDate'>
    ...
    /**
     * Device-cloud synchronization with pages.
     * Requires permission to synchronize personal data.
     *
     * @returns { Promise<void> } Returned promise.
     * @throws { BusinessError } 201 - Permission verification failed.
    ...
    /**
     * Subscribe the service die event.
     *
     * @param {'serviceDie'} type - Service die event.
    ...
    /**
     * UnSubscribe the service die event.
     *
     * @param {'serviceDie'} type - Service die event.
     * @param { Callback<void> } [callback] - Callback to report event.
     * @syscap SystemCapability.Health.HealthStore
    ...
    namespace healthDataTypes {
        ...
        /**
         * Constant definition of the SamplePoint dataType heart rate variability.
         *
         * @syscap SystemCapability.Health.HealthStore
         * @since 5.1.0(18)
         */
        const HEART_RATE_VARIABILITY: healthStore.DataType;
        /**
        ...
        /**
         * Constant definition of the SamplePoint dataType emotion.
         *
         * @syscap SystemCapability.Health.HealthStore
         * @since 5.1.0(18)
         */
        const EMOTION: healthStore.DataType;
        /**
    ...
    namespace healthFields {
        ...
        /**
         * Define the type for heart rate variability SamplePoint structure.
         *
         * @typedef { object }
         * @syscap SystemCapability.Health.HealthStore
         * @since 5.1.0(18)
        ...
        type HeartRateVariability = {
            /**
             * heart rate variability, value must be (0, 200].
             *
             * @type { number }
             * @syscap SystemCapability.Health.HealthStore
             * @since 5.1.0(18)
        ...
        /**
         * Define the type for emotion SamplePoint structure.
         *
         * @typedef { object }
         * @syscap SystemCapability.Health.HealthStore
         * @since 5.1.0(18)
        ...
        type Emotion = {
            /**
             * current emotional state, value must be [0, 100).
             *
             * @type { number }
             * @syscap SystemCapability.Health.HealthStore
             * @since 5.1.0(18)
        ...
        type RunningFeature = {
             ...
             *   '2.170':473.98846
             *
             * @type { ?healthStore.PaceValueType }
             * @syscap SystemCapability.Health.HealthStore
             * @since 5.0.0(12)
             */
         ...
         *
         * @extends healthStore.SequencePoint
    ...
    namespace healthModels {
        ...
        /**
         * Define the type for heart rate variability SamplePoint.
         *
         * @typedef { healthStore.SamplePoint<healthFields.HeartRateVariability> }
         * @syscap SystemCapability.Health.HealthStore
         * @since 5.1.0(18)
         */
        ...
        /**
         * Define the type for Emotion SamplePoint.
         *
         * @typedef { healthStore.SamplePoint<healthFields.Emotion> }
         * @syscap SystemCapability.Health.HealthStore
         * @since 5.1.0(18)
         */
    ...
    namespace samplePointHelper {
        ...
        /**
         * Namespace for heart rate variability related functionality.
         *
        ...
        namespace heartRateVariability {
            /**
             * The data type for heart rate variability.
             *
             * @syscap SystemCapability.Health.HealthStore
             * @since 5.1.0(18)
             */
            const DATA_TYPE: healthStore.DataType;
            /**
             * The model for HeartRateVariability SamplePoint.
             *
             * @typedef { healthModels.HeartRateVariability }
             * @syscap SystemCapability.Health.HealthStore
             * @since 5.1.0(18)
             */
            type Model = healthModels.HeartRateVariability;
            /**
             * The fields for HeartRateVariability Model.
             *
             * @typedef { healthFields.HeartRateVariability }
             * @syscap SystemCapability.Health.HealthStore
             * @since 5.1.0(18)
             */
        ...
        /**
         * Namespace for emotion related functionality.
         *
         * @namespace emotion
         * @syscap SystemCapability.Health.HealthStore
         * @since 5.1.0(18)
        ...
        namespace emotion {
            ...
            const DATA_TYPE: healthStore.DataType;
            /**
             * The model for emotion SamplePoint.
             *
             * @typedef { healthModels.Emotion }
             * @syscap SystemCapability.Health.HealthStore
             * @since 5.1.0(18)
             */
            type Model = healthModels.Emotion;
            /**
             * The fields for emotion Model.
             *
             * @typedef { healthFields.Emotion }
             * @syscap SystemCapability.Health.HealthStore
             * @since 5.1.0(18)
             */
